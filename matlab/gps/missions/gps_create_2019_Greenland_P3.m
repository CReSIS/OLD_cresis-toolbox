% script gps_create_2019_Greenland_P3
%
...
gps_path = fullfile(support_path,'gps','2019_Greenland_P3');
...
in_base_path = fullfile(data_support_path,'2019_Greenland_P3');

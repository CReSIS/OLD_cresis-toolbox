% script gps_create_2017_antarctica_Polar6
%
% Makes the GPS files for 2017 Antarctica Polar6 field season
...
gps_path = fullfile(support_path,'gps','2017_Antarctica_Polar6');
...
in_base_path = fullfile(data_support_path,'2017_Antarctica_Polar6');

% script gps_create_2019_antarctica_Polar6
%
% Makes the GPS files for 2019 Antarctic Polar6 field season
...
gps_path = fullfile(support_path,'gps','2019_Antarctica_Polar6');
...
in_base_path = fullfile(data_support_path,'2019_Antarctica_Polar6');

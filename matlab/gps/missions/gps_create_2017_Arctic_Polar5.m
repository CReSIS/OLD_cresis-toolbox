% script gps_create_2017_arctic_Polar5
%
% Makes the GPS files for 2017_Arctic_Polar5 field season
...
gps_path = fullfile(support_path,'gps','2017_Arctic_Polar5');
...
in_base_path = fullfile(data_support_path,'2017_Arctic_Polar5');
...
elseif strcmpi(gps_source_to_use,'AWI_final')
  ...
  gps_source{file_idx} = 'awi-final_20181022';
  sync_flag{file_idx} = 0;

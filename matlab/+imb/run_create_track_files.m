...
params = read_param_xls(ct_filename_param('accum_param_2022_Antarctica_BaslerMKB.xls'));

% params = ct_set_params(params,'cmd.generic',0);
% params = ct_set_params(params,'cmd.generic',1,'day_seg','20230110_02');
% params = ct_set_params(params,'cmd.generic',1,'day_seg','20230110_03');
% params = ct_set_params(params,'cmd.generic',1,'day_seg','20230113_02');
% params = ct_set_params(params,'cmd.generic',1,'day_seg','20230116_02');
% params = ct_set_params(params,'cmd.generic',1,'day_seg','20230124_02');
% params = ct_set_params(params,'cmd.generic',1,'day_seg','20230124_03');
% params = ct_set_params(params,'cmd.generic',1,'day_seg','20230125_01');
% params = ct_set_params(params,'cmd.generic',1,'day_seg','20230126_01');
% params = ct_set_params(params,'cmd.generic',1,'day_seg','20230126_03');
% params = ct_set_params(params,'cmd.generic',1,'day_seg','20230126_08');
% params = ct_set_params(params,'cmd.generic',1,'day_seg','20230127_01');

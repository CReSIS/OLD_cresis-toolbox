function [depth,er] = southPolePerm(freq,depth,plotFlag)
% [depth,er] = southPolePerm(freq,depth,plotFlag);
%
...
%-------------------------------------------------------------------------------
den = load(fullfile(gRadar.data_support_path,'em_model_data','ngrip_density_20030914.txt'));

function [depth,er] = gisp2Perm(freq,depth,plotFlag)
% [depth,er] = gisp2Perm(freq,depth,plotFlag);
%
...
%  - Linear extrapolate using the last 500 m
indexes = find(temp(end,1)-temp(:,1) <= 500);

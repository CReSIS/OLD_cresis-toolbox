...
% generation
beam.imgs = {[1 1; 2 2; 2 1; 3 1]};
% /process3_SSD/20150313/mcords/mcords5_20150314_004028_00.xml
% 10 us, 180-450 MHz
% 1: /process3_SSD/20150313/mcords/chan1/mcords5_01_20150314_004028_10_0000.bin
% 101: /process3_SSD/20150313/mcords/chan1/mcords5_01_20150314_005419_10_0100.bin

% /process3_SSD/20150313/mcords/mcords5_20150314_005906_00.xml
% 3 us, 180-450 MHz
% 1: /process3_SSD/20150313/mcords/chan1/mcords5_01_20150314_005906_13_0000.bin
% 131: /process3_SSD/20150313/mcords/chan1/mcords5_01_20150314_011518_13_0130.bin


% Which files to use in radiation pattern generation
param.radar_name = 'mcords5';
param.vectors.file.start_idx = 2;
param.vectors.file.stop_idx = 130;
param.vectors.file.base_dir = '/process3_SSD/20150313/mcords/';
param.vectors.file.adc_folder_name = 'chan%d';
param.vectors.file.file_prefix = 'mcords5_';
param.vectors.file.file_midfix = '_13_'; % FILES FOR SINGLE ELEMENTS
% param.vectors.file.file_midfix = '?'; % FILES FOR BEAM FORMING
param.records.file.adcs = [1:2];
...
for wf = 1:2
  ...
  param.radar.wfs(wf).rx_paths = [1 2];
  
  param.radar.wfs(wf).adc_gains = 10.^((52-[17 17])/20);
  param.radar.wfs(wf).chan_equal_dB = [0 0];
  param.radar.wfs(wf).chan_equal_deg = [0 0];
end

param.vectors.gps.time_offset = 0;

output_fn = '/scratch/roll_measurements_2015_Greenland_LC130.mat';

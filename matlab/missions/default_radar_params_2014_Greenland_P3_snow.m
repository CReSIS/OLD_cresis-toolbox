function param = default_radar_params_2014_Greenland_P3_snow
% param = default_radar_params_2014_Greenland_P3_snow
%
% Snow: 2014_Greenland_P3
%
...
default.records.frames.geotiff_fn = 'greenland/Landsat-7/Greenland_natural.tif';
...
for wf = 1:1
  ...
  default.radar.wfs(wf).adc_gains_dB = 20; % Radiometric calibration to 1/R^2
...
default.radar.wfs(1).BW_window = [2.304e9 7.4496e9];
...
% 
% default.config_regexp = '.*';
% default.name = 'Survey Mode 2-8 GHz Dual Waveform';
% defaults{end+1} = default;

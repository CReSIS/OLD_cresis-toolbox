function param = default_radar_params_2021_Alaska_SO_snow
...
param.season_name = '2021_Alaska_SO';
...
param.config.cresis.expected_rec_sizes = [125240];
...
default.radar.wfs(1).f1 = 6e9;
default.radar.wfs(1).Tpd = 250e-6;
default.radar.wfs(1).BW_window = [2e9 6e9];
default.radar.wfs(1).t_ref = -6.358e-6;

...
% from multiple ADCs)
if any(param.records.file.version == [1:5 8 11 101:102 405:406 409:411 413 414 415 420 421])
...
%     end
    ...
    elseif any(param.records.file.version == [415])
      ...
      if any(param.records.file.version == [1:8 11 102 401:404 407:408 420 421])

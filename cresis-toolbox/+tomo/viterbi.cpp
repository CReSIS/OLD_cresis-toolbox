...
{    
  ...
  detect obj(_row, _col, _in_data, _slayer, _blayer, _mask, _mu, _sigma,
             _mid, _egt_weight, _smooth_weight, _smooth_var, _smooth_slope,
             _bounds, _ms, _num_extra_tr, _extra_truth_x, _extra_truth_y,

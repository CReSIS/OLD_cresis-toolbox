%% This is a script to run GRID SEARCH on 3D data with TRWS

%% User Settings
user_settings_trws_grid_3D;                                 % (FILE TO EDIT FOR EACH TEST) set up the image sources, references, and the parameter combinations

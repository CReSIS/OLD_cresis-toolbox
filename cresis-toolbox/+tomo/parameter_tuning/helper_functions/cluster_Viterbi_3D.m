function [ result ] = cluster_Viterbi_3D(cpu_time, memory_req, detect_params_array, ...
  stats_array, num_combinations, sources, references)
%GRID_SEARCH_ON_CLUSTER Summary of this function goes here
%   Detailed explanation goes here

  cluster_compile;

  ctrl = cluster_new_batch;
  sparam.task_function = 'cluster_kernel_Viterbi_3D';

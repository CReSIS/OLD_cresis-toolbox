...
load_param = param;
load_param.load = struct('imgs','');
for img_idx = 1:length(param_array.array.imgs)
  load_param.load.imgs{img_idx} = param.array.imgs{img_idx}; 
end
[wfs,~] = data_load_wfs(load_param, records);

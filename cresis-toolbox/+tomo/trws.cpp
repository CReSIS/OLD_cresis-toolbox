        ...
        for (size_t h_idx = 0; h_idx < height; h_idx++) {
            ...
            for (size_t w_idx = 0; w_idx < width; w_idx++) {
                ...
                if (!transition_mu || !transition_sigma) {
                    ...
                    beta = norm_pdf((double)h, transition_mu[idx], transition_sigma[idx], smooth_weight[0]);
                }

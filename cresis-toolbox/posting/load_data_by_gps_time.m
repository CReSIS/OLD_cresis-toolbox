...
elseif strcmpi(param.radar_name,'mcords') ...
    || strcmpi(param.radar_name,'mcords2') ...
    || strcmpi(param.radar_name,'mcords3') ...
    || strcmpi(param.radar_name,'mcords4') ...
    || strcmpi(param.radar_name,'mcords5') ...
    || strcmpi(param.radar_name,'mcrds') ...
    || strcmpi(param.radar_name,'wise') ...
    || strcmpi(param.radar_name,'accum') ...
    || strcmpi(param.radar_name,'accum2') ...
    || strcmpi(param.radar_name,'snow') ...
    || strcmpi(param.radar_name,'kuband') ...
    || strcmpi(param.radar_name,'snow2') ...
    || strcmpi(param.radar_name,'snow3') ...
    || strcmpi(param.radar_name,'kuband2')...
    || strcmpi(param.radar_name,'kuband3')

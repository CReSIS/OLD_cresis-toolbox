...
% track = merge_structs(layer_tracker_profile, param.layer_tracker.track);
...
tmp_out_fn_dir = ct_filename_out(param,param.layer_tracker.echogram_source,'standard_tmp');
...
% Ask about changes to this part

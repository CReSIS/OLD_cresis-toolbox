...
img_format = 'jpg';
filename = '/cresis/snfs1/scratch/anjali/cluster_tuning/result_layer_tune_mean1.mat'; % where the matrix is saved. Images generated will be saved in the same folder

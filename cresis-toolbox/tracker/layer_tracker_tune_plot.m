...
img_format = 'jpg';
filename = '/cresis/snfs1/scratch/anjali/cluster_tuning/result_layer_viterbi_test.mat'; % where the matrix is saved. Images generated will be saved in the same folder

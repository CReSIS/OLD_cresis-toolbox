...
if any(strcmp(param.layer_tracker.track.method,'snake')) || any(strcmp(param.layer_tracker.track.method,'max')) || any(strcmp(param.layer_tracker.track.method,'fixed'))
  ...
  for frm_idx = 1:length(param.cmd.frms)
    ...
    %end
      ...
      elseif strcmpi(param.layer_tracker.track.method,'lsm')
        new_layer = tracker_lsm(data_struct,param);
      elseif strcmpi(param.layer_tracker.track.method,'stereo')
        new_layer = tracker_stereo(data_struct,param);
      elseif strcmpi(param.layer_tracker.track.method, 'mcmc')

...
try
  ...
  transition_weight = 1;
  warning('transition_weight not specified or invalid. Defaulting to %.2f.', transition_weight);
end
try
  gt_cutoff = track.viterbi.gt_cutoff;
catch ME
  gt_cutoff = 50;
  warning('gt_cutoff not specified or invalid. Defaulting to %.0f.', gt_cutoff);
end

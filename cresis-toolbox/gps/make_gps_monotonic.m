...
if isfield(gps,'radar_time')
  ...
  if ~all(good_mask)
    warning('radar_time has repeated records. Manual inspection is suggested. May need to run make_gps_monotonic.m in make_gps_SEASON.m for this particular file.');

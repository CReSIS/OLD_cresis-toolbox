% script make_gps_2016_greenland_TO
%
% Makes the GPS files for 2016 Greenland TO field season
...
gps_path = fullfile(support_path,'gps','2016_Greenland_TO');
...
in_base_path = fullfile(data_support_path,'2016_Greenland_TO');
...
elseif strcmpi(gps_source_to_use,'DTU')
  ...
  gps_source{file_idx} = 'inertial_explorer-post20161129';
  sync_flag{file_idx} = 0;

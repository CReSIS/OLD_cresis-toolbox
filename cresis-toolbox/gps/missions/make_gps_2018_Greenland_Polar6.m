% script make_gps_2018_greenland_Polar6
%
% Makes the GPS files for 2018 Greenland Polar6 field season
...
gps_path = fullfile(support_path,'gps','2018_Greenland_Polar6');
...
in_base_path = fullfile(data_support_path,'2018_Greenland_Polar6');

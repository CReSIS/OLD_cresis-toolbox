% script make_gps_2013_antarctica_Basler
%
...
if any(strcmpi('gps_20131231.mat',out_fns)) ...
  ...
  warning('Jan 11 and Dec 31 travelled across 180 deg line and GPS file produced by Novatel may have errors! Novatel smoothing will produce points which interpolate -179.999 to +179.999 and vice versa incorrectly and you have to manually remove these points from the .txt input file before running make_gps.');
  keyboard
end

...
params = read_param_xls(ct_filename_param('snow_param_2017_Greenland_P3.xls'),'20170407_02',{'analysis_coh_noise','analysis'});
...
params = ct_set_params(params,'cmd.generic',1,'day_seg','20170407_02');
...
for param_idx = 1:length(params)
  ...
  if param.cmd.generic
    ctrl_chain{end+1} = coh_noise_tracker(param,param_override);
  end
end

function change_static_param_qlook(old_filename,new_filename,out_path,ch1,ch2,ch3,ch4,ch5,ch6,ch7,ch8,ch9,ch10,ch11,ch12,ch13,ch14,ch15,ch16,ch17,ch18,ch19,ch20,ch21,ch22,ch23,ch24)
...
static_param.get_heights.imgs = {[ones([size(channel_selection,2) 1]),channel_selection.'],[2*ones([size(channel_selection,2) 1]),channel_selection.'],[3*ones([size(channel_selection,2) 1]),channel_selection.']};
static_param.get_heights.qlook.out_path = out_path;

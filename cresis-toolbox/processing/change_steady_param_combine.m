function change_steady_param_combine(old_filename,new_filename,new_method,out_path,ch1,ch2,ch3,ch4,ch5,ch6,ch7,ch8,ch9,ch10,ch11,ch12,ch13,ch14,ch15,ch16,ch17,ch18,ch19,ch20,ch21,ch22,ch23,ch24)
...
steady_param.combine.imgs = {[ones([size(channel_selection,2) 1]),channel_selection.'],[2*ones([size(channel_selection,2) 1]),channel_selection.'],[3*ones([size(channel_selection,2) 1]),channel_selection.']};
steady_param.combine.method = new_method;
steady_param.combine.out_path = out_path;

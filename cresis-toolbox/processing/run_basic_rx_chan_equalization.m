...
%   param.img = cat(2,3*ones(24,1),[1:24].'); param.ref_wf_adc = 12;
  param.img = cat(2,3*ones(8,1),[9:16].'); param.ref_wf_adc = 4; % Center subarray
%   param.img = cat(2,3*ones(8,1),[1:8].'); param.ref_wf_adc = 4; % Left subarray
%   param.img = cat(2,3*ones(8,1),[17:24].'); param.ref_wf_adc = 4; % Right subarray

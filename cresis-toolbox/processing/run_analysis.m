...
params = read_param_xls(ct_filename_param('rds_param_2018_Antarctica_Ground.xls'),'',{'analysis_stat','analysis'});
...
% params = ct_set_params(params,'analysis.presums',4);
% params = ct_set_params(params,'analysis.cmd{1}.dec',10);

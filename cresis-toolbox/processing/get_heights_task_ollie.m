function [success surfTimes] = get_heights_task_ollie(steady_param_file_name,dynamic_param_file_name,frm,break_id)
% [success surfTimes] = get_heights_task_ollie(steady_param_file_name,dynamic_param_file_name,frm,break_id)
...
param.proc.frm = dynamic_param.frms.(['frm',num2str(frm)]).frm_id;

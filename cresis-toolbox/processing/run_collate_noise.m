% script run_collate_noise
%
% Runs collate_noise
%  
% Bug: The frequency axis shows fft_length
% Bug: Simulate_noise for overwriting stat data is TBD 
%
...
% param_override.analysis.simulate_noise = 0; %Set 1/0; Default: 0

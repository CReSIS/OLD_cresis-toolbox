function combine_wf_chan_combine_task_ollie(static_param_file_name)
% combine_wf_chan_combine_task_ollie(static_param_file_name)
%
% This functions is compiled and used for manual job submission to Slurm on
% Ollie using batch_combine_2.sh.
%

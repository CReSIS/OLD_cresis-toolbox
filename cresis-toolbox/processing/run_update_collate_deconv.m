...
% param_override.update_collate_deconv.cmd{end}.idxs = [1 2 3];
param_override.update_collate_deconv.cmd{end+1}.method = 'replace';
param_override.update_collate_deconv.cmd{end}.day_seg = {'20170323_02'}
% param_override.update_collate_deconv.cmd{end}.day_seg = {'20170320_01'}

function [success] = csarp_task_ollie(steady_param_file_name,dynamic_param_file_name,frm,chunk,wf,adc)
% [success] = csarp_task_ollie(steady_param_file_name,dynamic_param_file_name,frm,chunk,wf,adc)

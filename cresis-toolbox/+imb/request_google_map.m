...
function obj = request_google_map(obj, c_lat, c_lon, zoom)
  ...
  %% Get the raster map from Google Maps API
  ...
  %% Store important coordinates in the object
  ...
  % Calculate the pixel coordinates of the map vertices
  ...
  % Convert the above calculated pixel coordinates of the vertices to
  % world coordinates

...
obj.cursor.gps_time = obj.crossovers.gps_time(idx);
obj.cursor.x = interp1(obj.eg.map_gps_time,obj.eg.map_x,obj.crossovers.gps_time(idx),'linear','extrap');
obj.cursor.y = interp1(obj.eg.map_gps_time,obj.eg.map_y,obj.crossovers.gps_time(idx),'linear','extrap');

...
if obj.map.source==1
  ...
  obj.map.sel.frame_name = b.properties.frame;
  obj.map.sel.season_name = b.properties.season;
  obj.map.sel.segment_id = b.properties.segment_id;
  
  set(obj.map_panel.h_cur_sel,{'XData','YData'},{obj.layerdata.x(frm_mask),obj.layerdata.y(frm_mask)});
  new_xdata = obj.layerdata.x(frm_mask);
  new_ydata = obj.layerdata.y(frm_mask);

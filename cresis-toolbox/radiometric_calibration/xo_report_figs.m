...
if 1
  ...
  if save_figs
    ...
    fig_fn = fullfile(reuse_loc, sprintf('%s_report_geoplot.fig', xo_hdr));
    fprintf('Saving %s\n', fig_fn);
    %   ct_saveas(gcf,fig_fn);
    fig_fn = fullfile(reuse_loc, sprintf('%s_report_geoplot.png', xo_hdr));
    fprintf('Saving %s\n', fig_fn);
    ct_saveas(gcf,fig_fn);
  end
end
...
if 1
  ...
  if save_figs
    set(findobj(gcf,'type','axes'),'FontWeight', 'Bold', 'FontSize',12);
    set(gcf, 'Position', get(0, 'Screensize'));
    fig_fn = fullfile(reuse_loc, sprintf('%s_report_angles.fig', xo_hdr));
    fprintf('Saving %s\n', fig_fn);
    %   ct_saveas(gcf,fig_fn);
    fig_fn = fullfile(reuse_loc, sprintf('%s_report_angles.png', xo_hdr));
    fprintf('Saving %s\n', fig_fn);
    ct_saveas(gcf,fig_fn);
  end
...
if 1
  ...
  if save_figs
    set(findobj(gcf,'type','axes'),'FontWeight', 'Bold', 'FontSize',12);
    set(gcf, 'Position', get(0, 'Screensize'));
    fig_fn = fullfile(reuse_loc, sprintf('%s_report_elev.fig', xo_hdr));
    fprintf('Saving %s\n', fig_fn);
    %   ct_saveas(gcf,fig_fn);
    fig_fn = fullfile(reuse_loc, sprintf('%s_report_elev.png', xo_hdr));
    fprintf('Saving %s\n', fig_fn);
    ct_saveas(gcf,fig_fn);
  end
...
if 1
  ...
  if save_figs
    set(findobj(gcf,'type','axes'),'FontWeight', 'Bold', 'FontSize',12);
    set(gcf, 'Position', get(0, 'Screensize'));
    fig_fn = fullfile(reuse_loc, sprintf('%s_report_3D.fig', xo_hdr));
    fprintf('Saving %s\n', fig_fn);
    %   ct_saveas(gcf,fig_fn);
    fig_fn = fullfile(reuse_loc, sprintf('%s_report_3D.png', xo_hdr));
    fprintf('Saving %s\n', fig_fn);
    ct_saveas(gcf,fig_fn);
  end

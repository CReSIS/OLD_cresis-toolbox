...
%% USER INPUT
sys = 'rds';
param_sheets = {ct_filename_param('rds_param_2012_Greenland_P3.xls'), ...
  ct_filename_param('rds_param_2013_Greenland_P3.xls')};
...
for xls_idx = 1:length(param_sheets)
  ...
  param.properties.radars{end+1} = params(1).radar_name;

...
AT_data.crevasse.apex_bin.P10a = islocalmax(AT_data.interp_data.P10a);
AT_data.crevasse.apex_bin.P10b = islocalmax(AT_data.interp_data.P10b);
...
AT_data.crevasse.apex_pic_P10a = AT_data.interp_data.P10a.*AT_data.crevasse.apex_bin.P10a;
AT_data.crevasse.apex_pic_P10a(AT_data.crevasse.apex_pic_P10a == 0) = NaN;
AT_data.crevasse.apex_pic_P10b = AT_data.interp_data.P10b.*AT_data.crevasse.apex_bin.P10b;
AT_data.crevasse.apex_pic_P10b(AT_data.crevasse.apex_pic_P10b == 0) = NaN;
...
AT_data.crevasse.base_bin.P10a = islocalmin(AT_data.interp_data.P10a);
AT_data.crevasse.base_bin.P10b = islocalmin(AT_data.interp_data.P10b);
...
AT_data.crevasse.base_pic_P10a = AT_data.interp_data.P10a.*AT_data.crevasse.base_bin.P10a;
AT_data.crevasse.base_pic_P10a(AT_data.crevasse.base_pic_P10a == 0) = NaN;
AT_data.crevasse.base_pic_P10b = AT_data.interp_data.P10b.*AT_data.crevasse.base_bin.P10b;
AT_data.crevasse.base_pic_P10b(AT_data.crevasse.base_pic_P10b == 0) = NaN;
...
crevasse_2013 = AT_data.crevasse.base_pic_P10a;
crevasse_2014 = AT_data.crevasse.base_pic_P10b;
crevasse_2017 = AT_data.crevasse.base_pic_P17;
writematrix(crevasse_2007, 'P3_Crevasse_2007.csv','Delimiter','comma');
writematrix(crevasse_2010a, 'P3_Crevasse_2010a.csv','Delimiter','comma');
writematrix(crevasse_2010b, 'P3_Crevasse_2010b.csv','Delimiter','comma');
writematrix(crevasse_2017, 'P3_Crevasse_2017.csv','Delimiter','comma');
%% Reload new csv in after editting
AT_data.crevasse.base_pic_P11 = csvread('P3_Crevasse_2007.csv');
AT_data.crevasse.base_pic_P10a = csvread('P3_Crevasse_2010a.csv');
AT_data.crevasse.base_pic_P10b = csvread('P3_Crevasse_2010b.csv');
AT_data.crevasse.base_pic_P17 = csvread('P3_Crevasse_2017.csv');
%% 2007 Basal Crevasse picks

%% 2010a Basal Crevasse picks

%% 2010b Basal Crevasse picks

...
AT_data.elevB.P2012 = (pass(2).layers(2).layer_elev);
...
AT_data.elevS.P2012 = (pass(2).layers(1).layer_elev);
...
AT_data.pass.P2012 = pass(2).along_track;
...
AT_data.AT_vel.P2012 = pass(baseline_master_idx).along_track + pass(2).vel;
...
AT_data.interp_data.P12 = interp1(AT_data.Btrack_End_Clip.P12, ...
  AT_data.elev_End_Clip.P2012, AT_data.query_array.P07);
...
AT_data.interp_data.P14 = interp1(AT_data.Btrack_End_Clip.P14, ...
  AT_data.elev_End_Clip.P2014, AT_data.query_array.P07);

...
% Distance difference
AT_data.dist_11_14 = AT_data.AT_vel.P2011 - AT_data.AT_vel.P2014;
AT_data.dist_14_18 = AT_data.AT_vel.P2014 - AT_data.AT_vel.P2018;
AT_data.dist_11_18 = AT_data.AT_vel.P2011 - AT_data.AT_vel.P2018;
...
AT_data.elev_Beg_Clip_VEL.P2011 = AT_data.AT_vel.P2011...
  (AT_data.find_AT_value.P11:end); 
...
AT_data.elev_End_Clip_VEL.P2011 = AT_data.elev_Beg_Clip_VEL.P2011...
  (1:length(AT_data.Btrack_End_Clip.P11));
...
AT_data.elev_Beg_Clip_DIST.P2011 = AT_data.dist_11_14...
  (AT_data.find_AT_value.P11:end); 
AT_data.elev_Beg_Clip_DIST.P2014 = AT_data.dist_14_18...
  (AT_data.find_AT_value.P14:end);
AT_data.elev_Beg_Clip_DIST.P2018 = AT_data.dist_11_18...
  (AT_data.find_AT_value.P18:end);
  
% Velocity data end clipping from end of Along track data DIST
AT_data.elev_End_Clip_DIST.P2011 = AT_data.elev_Beg_Clip_DIST.P2011...
  (1:length(AT_data.Btrack_End_Clip.P11));
...
% VEL
AT_data.array_size.P11_VEL = size(AT_data.elev_End_Clip_VEL.P2011);
...
% DIST
AT_data.array_size.P11_DIST = size(AT_data.elev_End_Clip_DIST.P2011);
...
% 2011 VEL
AT_data.interp_data.P11_VEL = interp1(AT_data.Btrack_End_Clip.P11, ...
  AT_data.elev_End_Clip_VEL.P2011, AT_data.query_array.P11);
 
% 2014 VEL
AT_data.interp_data.P14_VEL = interp1(AT_data.Btrack_End_Clip.P14, ...
  AT_data.elev_End_Clip_VEL.P2014, AT_data.query_array.P11);
  
% 2018 VEL
AT_data.interp_data.P18_VEL = interp1(AT_data.Btrack_End_Clip.P18, ...
  AT_data.elev_End_Clip_VEL.P2018, AT_data.query_array.P11);
...
% 2011 DIST
AT_data.interp_data.P11_DIST = interp1(AT_data.Btrack_End_Clip.P11, ...
  AT_data.elev_End_Clip_DIST.P2011, AT_data.query_array.P11);
 
% 2014 DIST
AT_data.interp_data.P14_DIST = interp1(AT_data.Btrack_End_Clip.P14, ...
  AT_data.elev_End_Clip_DIST.P2014, AT_data.query_array.P11);
  
% 2018 DIST
AT_data.interp_data.P18_DIST = interp1(AT_data.Btrack_End_Clip.P18, ...
  AT_data.elev_End_Clip_DIST.P2018, AT_data.query_array.P11);

% Find ice thickness based of difference of interp data
% 2011
AT_data.ice_thickness_interp.P11 = AT_data.interp_data.P11_Surf - AT_data.interp_data.P11;
% 2014
...
Crevasse_apex = islocalmax(AT_data.interp_data.P11);
Crevasse_base = islocalmin(AT_data.interp_data.P11);
...
h1 = plot(AT_data.query_array.P11/1e3, AT_data.interp_data.P11);
hold on
h2 = plot(AT_data.query_array.P11/1e3, Crevasse_base);
title('Test Plot 2 - Interpolated files same location as Originals');
xlabel('Along Track (km)');
ylabel('Elevation (m)');
legend('interpolated 2011', 'crevasse base', 'Location', 'southeast');

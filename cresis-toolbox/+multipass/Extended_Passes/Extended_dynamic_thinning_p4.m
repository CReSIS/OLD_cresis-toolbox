%% DYNAMIC VERSION for autoloading all files in Folder - Petermann 4
...
myfiles = pwd; 
Velocity_CSV_1 = dir(fullfile(myfiles,'P4M_*.csv'));
...
%%
figure(1)
plot(XY_data(2).AT_dist/1e3, XY_data(1).Surf)
hold on
plot(XY_data(2).AT_dist/1e3, XY_data(1).Bed)
...
XY_data(2).Dynamic_component_S150 = ((XY_data(2).div_11_2t + XY_data(2).div_12t + XY_data(2).div_13t)...
    .*XY_data(2).Mean_Thickness_Smooth150);
XY_data(2).Dynamic_component_S100 = ((XY_data(2).div_11_2t + XY_data(2).div_12t + XY_data(2).div_13t)...
...
XY_data(3).Dynamic_component_S150 = ((XY_data(3).div_13_2t + XY_data(3).div_14t)...
    .*XY_data(3).Mean_Thickness_Smooth150);
XY_data(3).Dynamic_component_S100 = ((XY_data(3).div_13_2t + XY_data(3).div_14t)...

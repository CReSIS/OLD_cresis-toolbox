%% DYNAMIC VERSION for autoloading all files in Folder - ZI 1
...
% loop will fail.
file_path = cd('C:\Users\c262b531\Documents\scripts\cresis-toolbox\cresis-toolbox\+multipass\QGIS_processed_DIV_SMB\ZI1\');
myfiles = pwd; 
Velocity_CSV_1 = dir(fullfile(myfiles,'ZI1M_*.csv'));
...
plot(XY_data(6).AT_dist/1e3, XY_data(6).Surf, 'Color','m');
plot(XY_data(6).AT_dist/1e3, XY_data(6).Bed, 'Color','m');
title('ZI uncorrected');
xlabel('distance km');
ylabel('elevation m');
legend('2010','2014','2016','2017','2018','2019','Location','southeast');
%% TIDAL CORRECTIONS
...
% tidal Amplitudes
XY_data(1).mean_tidal_c = (0.1495 + 0.1810)/2;
XY_data(2).mean_tidal_c = (0.3298 + 0.3428)/2;
XY_data(3).mean_tidal_c = (0.08229 + 0.04655)/2;
XY_data(4).mean_tidal_c = (0.3427 + 0.3344)/2;
XY_data(5).mean_tidal_c = (0.1568 + 0.1756)/2;
XY_data(6).mean_tidal_c = (-0.3401 + (-0.3456))/2;
XY_data(7).mean_tidal_c = (-0.3117 + (-0.3199))/2;
...
XY_data(4).ocean_surface = XY_data(4).Surf(3569:end) - XY_data(4).mean_tidal_c;
XY_data(5).ocean_surface = XY_data(5).Surf(3569:end) - XY_data(5).mean_tidal_c;
XY_data(6).ocean_surface = XY_data(6).Surf(3569:end) + XY_data(6).mean_tidal_c;
XY_data(7).ocean_surface = XY_data(7).Surf(3569:end) + XY_data(7).mean_tidal_c;
...
XY_data(5).AT_ocean = XY_data(5).AT_dist(3516:end);
XY_data(6).AT_ocean = XY_data(6).AT_dist(3516:end);
XY_data(7).AT_ocean = XY_data(7).AT_dist(3516:end);
...
XY_data(7).surf_tidal_elevation_align = XY_data(7).Surf - XY_data(7).mean_ocean_surf_5km + XY_data(7).mean_tidal_c;
...
XY_data(7).bed_tidal_elevation_align = XY_data(7).Bed - XY_data(7).mean_ocean_surf_5km + XY_data(7).mean_tidal_c;
...
XY_data(7).surf_tidal_align_smooth_150 = smooth(XY_data(7).surf_tidal_elevation_align, 150);
...
XY_data(7).bed_tidal_align_smooth_150 = smooth(XY_data(7).bed_tidal_elevation_align, 150);
...
XY_data(7).surf_tidal_align_smooth_100 = smooth(XY_data(7).surf_tidal_elevation_align, 100);
...
XY_data(7).bed_tidal_align_smooth_100 = smooth(XY_data(7).bed_tidal_elevation_align, 100);
...
% plot(XY_data(1).AT_dist/1e3, XY_data(7).surf_tidal_elevation_align, 'Color','y');
% plot(XY_data(1).AT_dist/1e3, XY_data(7).Bed_tidal_elevation_align, 'Color','y');
% legend show

%% 2 - CLIPPING EACH FIELD FOR ALIGNMENT
for i = 1:7 % define as # of passes or use length(fieldnames(XY_data)) on start 
...
time_offset.P10 = (365/365); % 2010
time_offset.P11 = (365/365); % 2011
time_offset.P12 = (366/366); % 2012
time_offset.P13 = (365/365); % 2013
time_offset.P14 = (127/365); % 2014
time_offset.P14_2 = (238/365); % 2014 post echogram uses 20140508 date
time_offset.P14_alt = (118/365); % 2014 alternate
time_offset.P14_2_alt = (247/365); % 2014 post echogram uses 20140508 date alt
...
time_offset.N_years_alt = (time_offset.P10 + time_offset.P11 + time_offset.P12 + ...
    time_offset.P13 + time_offset.P14_alt + time_offset.P14_2_alt + time_offset.P15 + ...
    time_offset.P16 + time_offset.P16_2 + time_offset.P17 + time_offset.P17_2 + ...
    + time_offset.P18 + time_offset.P18_2 + time_offset.P19); 
...
for i = 1:numel(XY_data)
    ...
    %2011 - 2019 mean
    XY_data(i).div_11_19_mean = (XY_data(i).div_11t + ...
      XY_data(i).div_12t + XY_data(i).div_13t + XY_data(i).div_13_2t + ...
      XY_data(i).div_14t + XY_data(i).div_15t + XY_data(i).div_15_2t + ...
      XY_data(i).div_16t + XY_data(i).div_17t + XY_data(i).div_18t + ...
      XY_data(i).div_19t);
    % 2010 - 2017 smooth
...
% SMB
XY_data(5).Mean_SMB = (XY_data(5).SMB_17_2t + XY_data(5).SMB_18t);
...
for j = 1:numel(export_melt_rates)
    name(j).file = append('ZI1M_melt_E_', string(XY_data(j).year),'_',string(XY_data(j+1).year),'.csv');

...
% loop will fail.
file_path = cd('C:\Users\c262b531\Documents\scripts\cresis-toolbox\cresis-toolbox\+multipass\Extended_Passes\New_Petermann_testing\');
myfiles = pwd; 
Velocity_CSV_1 = dir(fullfile(myfiles,'P1_NEW*.csv'));
    for i = 1:numel(Velocity_CSV_1)
        ...
        XY_data(i).X = XY_data(i).data(1:end,1).';
        XY_data(i).Y = XY_data(i).data(1:end,2).';
        XY_data(i).Lons = XY_data(i).data(1:end,3).';
        XY_data(i).Lats = XY_data(i).data(1:end,4).';
        XY_data(i).Surf = XY_data(i).data(1:end,5).';
        XY_data(i).Bed = XY_data(i).data(1:end,6).';
        XY_data(i).Thickness = XY_data(i).data(1:end,7).';
        XY_data(i).AT_dist = XY_data(i).data(1:end,8).';
        XY_data(i).Vel_mag = XY_data(i).data(1:end,9).';
        ...
        XY_data(i).year = str2double(XY_data(i).name_parts(6));
    end
...
%%
% % polyfits
% dyn_thin_poly = polyfit(XY_data(1).Interp_AT_Dist/1e3,XY_data(1).Interp_Div_14_15.*XY_data(1).Interp_Thickness,1);
% div_poly = polyfit(XY_data(1).Interp_AT_Dist/1e3,XY_data(1).Interp_Div_14_15, 1 );
% 
% %polyvals
% dyn_vals = polyval(dyn_thin_poly, XY_data(1).Interp_AT_Dist/1e3);
% div_vals = polyval(div_poly, XY_data(1).Interp_AT_Dist/1e3);
% 
% 
% figure(101)
% plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(1).Interp_Div_14_15.*XY_data(1).Interp_Thickness, 'Color','r');
% hold on 
% plot(XY_data(1).Interp_AT_Dist/1e3, dyn_vals, 'Color','b');
% title('dynamic thinning 14-15 2000m');
% xlabel('distance km');
% ylabel('dynamic thinning m');
% legend('interp_div','polyfit','Location','southeast');
% 
% figure(102)
% plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(1).Interp_Div_14_15, 'Color','r');
% hold on 
% plot(XY_data(1).Interp_AT_Dist/1e3, div_vals, 'Color','b');
% title('divergence 14-15 2000m');
% xlabel('distance km');
% ylabel('dynamic thinning m');
% legend('interp_div','polyfit','Location','southeast');
...
%% Smoothed 200
XY_data(1).surf_tidal_align_smooth_200 = smooth(XY_data(1).surf_tidal_elevation_align(1:3890), 200);
XY_data(2).surf_tidal_align_smooth_200 = smooth(XY_data(2).surf_tidal_elevation_align(1:3695), 200);
XY_data(3).surf_tidal_align_smooth_200 = smooth(XY_data(3).surf_tidal_elevation_align(1:3769), 200);
XY_data(4).surf_tidal_align_smooth_200 = smooth(XY_data(4).surf_tidal_elevation_align(1:3929), 200);
XY_data(5).surf_tidal_align_smooth_200 = smooth(XY_data(5).surf_tidal_elevation_align(1:4044), 200);
XY_data(6).surf_tidal_align_smooth_200 = smooth(XY_data(6).surf_tidal_elevation_align(1:4101), 200);

XY_data(1).bed_tidal_align_smooth_200 = smooth(XY_data(1).bed_tidal_elevation_align(1:3890), 200);
XY_data(2).bed_tidal_align_smooth_200 = smooth(XY_data(2).bed_tidal_elevation_align(1:3695), 200);
XY_data(3).bed_tidal_align_smooth_200 = smooth(XY_data(3).bed_tidal_elevation_align(1:3769), 200);
XY_data(4).bed_tidal_align_smooth_200 = smooth(XY_data(4).bed_tidal_elevation_align(1:3929), 200);
XY_data(5).bed_tidal_align_smooth_200 = smooth(XY_data(5).bed_tidal_elevation_align(1:4044), 200);
XY_data(6).bed_tidal_align_smooth_200 = smooth(XY_data(6).bed_tidal_elevation_align(1:4101), 200);

% smooth 200
fig = figure(116);
tiledlayout(3,1)
ax1 = nexttile;
plot(XY_data(1).AT_dist(1:3890)/1e3, XY_data(1).surf_tidal_align_smooth_200);
hold on
plot(XY_data(2).AT_dist(1:3695)/1e3, XY_data(2).surf_tidal_align_smooth_200);
plot(XY_data(3).AT_dist(1:3769)/1e3, XY_data(3).surf_tidal_align_smooth_200);
plot(XY_data(4).AT_dist(1:3929)/1e3, XY_data(4).surf_tidal_align_smooth_200);
plot(XY_data(5).AT_dist(1:4044)/1e3, XY_data(5).surf_tidal_align_smooth_200);
plot(XY_data(6).AT_dist(1:4101)/1e3, XY_data(6).surf_tidal_align_smooth_200);
ax1.YLim = [-10 110];
ylabel('Elevation WGS (m)');

ax2 = nexttile;
plot(XY_data(1).AT_dist(1:3890)/1e3, XY_data(1).bed_tidal_align_smooth_200);
hold on
plot(XY_data(2).AT_dist(1:3695)/1e3, XY_data(2).bed_tidal_align_smooth_200);
plot(XY_data(3).AT_dist(1:3769)/1e3, XY_data(3).bed_tidal_align_smooth_200);
plot(XY_data(4).AT_dist(1:3929)/1e3, XY_data(4).bed_tidal_align_smooth_200);
plot(XY_data(5).AT_dist(1:4044)/1e3, XY_data(5).bed_tidal_align_smooth_200);
plot(XY_data(6).AT_dist(1:4101)/1e3, XY_data(6).bed_tidal_align_smooth_200);
ylabel('Elevation WGS (m)');

ax3 = nexttile;
plot(XY_data(1).AT_vel_corrected(1:3890)/1e3, XY_data(1).bed_tidal_align_smooth_200);
hold on
plot(XY_data(2).AT_vel_corrected(1:3695)/1e3, XY_data(2).bed_tidal_align_smooth_200);
plot(XY_data(3).AT_vel_corrected(1:3769)/1e3, XY_data(3).bed_tidal_align_smooth_200);
plot(XY_data(4).AT_vel_corrected(1:3929)/1e3, XY_data(4).bed_tidal_align_smooth_200);
plot(XY_data(5).AT_vel_corrected(1:4044)/1e3, XY_data(5).bed_tidal_align_smooth_200);
plot(XY_data(6).AT_vel_corrected(1:4101)/1e3, XY_data(6).bed_tidal_align_smooth_200);
ylabel('Elevation WGS (m)');
leg = legend({'2011', '2014', '2015', '2017', '2018', '2019'},'Orientation','Vertical');
...
han.XLabel.Visible='on';
xlabel(han,'Along Track Distance (km)');
title(han, 'Aligned 200pt Smooth Surface, Bed, and advection-corrected bed');
linkaxes([ax1 ax2 ax3],'x')
grid([ax1 ax2 ax3],'on');

%% Smoothed 150
XY_data(1).surf_tidal_align_smooth_150 = smooth(XY_data(1).surf_tidal_elevation_align(1:3890), 150);
XY_data(2).surf_tidal_align_smooth_150 = smooth(XY_data(2).surf_tidal_elevation_align(1:3695), 150);
XY_data(3).surf_tidal_align_smooth_150 = smooth(XY_data(3).surf_tidal_elevation_align(1:3769), 150);
XY_data(4).surf_tidal_align_smooth_150 = smooth(XY_data(4).surf_tidal_elevation_align(1:3929), 150);
XY_data(5).surf_tidal_align_smooth_150 = smooth(XY_data(5).surf_tidal_elevation_align(1:4044), 150);
XY_data(6).surf_tidal_align_smooth_150 = smooth(XY_data(6).surf_tidal_elevation_align(1:4101), 150);

XY_data(1).bed_tidal_align_smooth_150 = smooth(XY_data(1).bed_tidal_elevation_align(1:3890), 150);
XY_data(2).bed_tidal_align_smooth_150 = smooth(XY_data(2).bed_tidal_elevation_align(1:3695), 150);
XY_data(3).bed_tidal_align_smooth_150 = smooth(XY_data(3).bed_tidal_elevation_align(1:3769), 150);
XY_data(4).bed_tidal_align_smooth_150 = smooth(XY_data(4).bed_tidal_elevation_align(1:3929), 150);
XY_data(5).bed_tidal_align_smooth_150 = smooth(XY_data(5).bed_tidal_elevation_align(1:4044), 150);
XY_data(6).bed_tidal_align_smooth_150 = smooth(XY_data(6).bed_tidal_elevation_align(1:4101), 150);

% smooth 150
fig = figure(117);
tiledlayout(3,1)
ax1 = nexttile;
plot(XY_data(1).AT_dist(1:3890)/1e3, XY_data(1).surf_tidal_align_smooth_150);
hold on
plot(XY_data(2).AT_dist(1:3695)/1e3, XY_data(2).surf_tidal_align_smooth_150);
plot(XY_data(3).AT_dist(1:3769)/1e3, XY_data(3).surf_tidal_align_smooth_150);
plot(XY_data(4).AT_dist(1:3929)/1e3, XY_data(4).surf_tidal_align_smooth_150);
plot(XY_data(5).AT_dist(1:4044)/1e3, XY_data(5).surf_tidal_align_smooth_150);
plot(XY_data(6).AT_dist(1:4101)/1e3, XY_data(6).surf_tidal_align_smooth_150);
ax1.YLim = [-10 110];
ylabel('Elevation WGS (m)');

ax2 = nexttile;
plot(XY_data(1).AT_dist(1:3890)/1e3, XY_data(1).bed_tidal_align_smooth_150);
hold on
plot(XY_data(2).AT_dist(1:3695)/1e3, XY_data(2).bed_tidal_align_smooth_150);
plot(XY_data(3).AT_dist(1:3769)/1e3, XY_data(3).bed_tidal_align_smooth_150);
plot(XY_data(4).AT_dist(1:3929)/1e3, XY_data(4).bed_tidal_align_smooth_150);
plot(XY_data(5).AT_dist(1:4044)/1e3, XY_data(5).bed_tidal_align_smooth_150);
plot(XY_data(6).AT_dist(1:4101)/1e3, XY_data(6).bed_tidal_align_smooth_150);
ylabel('Elevation WGS (m)');

ax3 = nexttile;
plot(XY_data(1).AT_vel_corrected(1:3890)/1e3, XY_data(1).bed_tidal_align_smooth_150);
hold on
plot(XY_data(2).AT_vel_corrected(1:3695)/1e3, XY_data(2).bed_tidal_align_smooth_150);
plot(XY_data(3).AT_vel_corrected(1:3769)/1e3, XY_data(3).bed_tidal_align_smooth_150);
plot(XY_data(4).AT_vel_corrected(1:3929)/1e3, XY_data(4).bed_tidal_align_smooth_150);
plot(XY_data(5).AT_vel_corrected(1:4044)/1e3, XY_data(5).bed_tidal_align_smooth_150);
plot(XY_data(6).AT_vel_corrected(1:4101)/1e3, XY_data(6).bed_tidal_align_smooth_150);
ylabel('Elevation WGS (m)');
leg = legend({'2011', '2014', '2015', '2017', '2018', '2019'},'Orientation','Vertical');
leg.Layout.Tile = 'East';
...
han.XLabel.Visible='on';
xlabel(han,'Along Track Distance (km)');
title(han, 'Aligned 150pt Smooth Surface, Bed, and advection-corrected bed');
linkaxes([ax1 ax2 ax3],'x')
grid([ax1 ax2 ax3],'on');

%% Smooth 100
XY_data(1).surf_tidal_align_smooth_100 = smooth(XY_data(1).surf_tidal_elevation_align(1:3890), 100);
XY_data(2).surf_tidal_align_smooth_100 = smooth(XY_data(2).surf_tidal_elevation_align(1:3695), 100);
XY_data(3).surf_tidal_align_smooth_100 = smooth(XY_data(3).surf_tidal_elevation_align(1:3769), 100);
XY_data(4).surf_tidal_align_smooth_100 = smooth(XY_data(4).surf_tidal_elevation_align(1:3929), 100);
XY_data(5).surf_tidal_align_smooth_100 = smooth(XY_data(5).surf_tidal_elevation_align(1:4044), 100);
XY_data(6).surf_tidal_align_smooth_100 = smooth(XY_data(6).surf_tidal_elevation_align(1:4101), 100);

XY_data(1).bed_tidal_align_smooth_100 = smooth(XY_data(1).bed_tidal_elevation_align(1:3890), 100);
XY_data(2).bed_tidal_align_smooth_100 = smooth(XY_data(2).bed_tidal_elevation_align(1:3695), 100);
XY_data(3).bed_tidal_align_smooth_100 = smooth(XY_data(3).bed_tidal_elevation_align(1:3769), 100);
XY_data(4).bed_tidal_align_smooth_100 = smooth(XY_data(4).bed_tidal_elevation_align(1:3929), 100);
XY_data(5).bed_tidal_align_smooth_100 = smooth(XY_data(5).bed_tidal_elevation_align(1:4044), 100);
XY_data(6).bed_tidal_align_smooth_100 = smooth(XY_data(6).bed_tidal_elevation_align(1:4101), 100);

% smooth 150
fig = figure(118);
tiledlayout(3,1)
ax1 = nexttile;
plot(XY_data(1).AT_dist(1:3890)/1e3, XY_data(1).surf_tidal_align_smooth_100);
hold on
plot(XY_data(2).AT_dist(1:3695)/1e3, XY_data(2).surf_tidal_align_smooth_100);
plot(XY_data(3).AT_dist(1:3769)/1e3, XY_data(3).surf_tidal_align_smooth_100);
plot(XY_data(4).AT_dist(1:3929)/1e3, XY_data(4).surf_tidal_align_smooth_100);
plot(XY_data(5).AT_dist(1:4044)/1e3, XY_data(5).surf_tidal_align_smooth_100);
plot(XY_data(6).AT_dist(1:4101)/1e3, XY_data(6).surf_tidal_align_smooth_100);
ax1.YLim = [-10 110];
ylabel('Elevation WGS (m)');

ax2 = nexttile;
plot(XY_data(1).AT_dist(1:3890)/1e3, XY_data(1).bed_tidal_align_smooth_100);
hold on
plot(XY_data(2).AT_dist(1:3695)/1e3, XY_data(2).bed_tidal_align_smooth_100);
plot(XY_data(3).AT_dist(1:3769)/1e3, XY_data(3).bed_tidal_align_smooth_100);
plot(XY_data(4).AT_dist(1:3929)/1e3, XY_data(4).bed_tidal_align_smooth_100);
plot(XY_data(5).AT_dist(1:4044)/1e3, XY_data(5).bed_tidal_align_smooth_100);
plot(XY_data(6).AT_dist(1:4101)/1e3, XY_data(6).bed_tidal_align_smooth_100);
ylabel('Elevation WGS (m)');

ax3 = nexttile;
plot(XY_data(1).AT_vel_corrected(1:3890)/1e3, XY_data(1).bed_tidal_align_smooth_100);
hold on
plot(XY_data(2).AT_vel_corrected(1:3695)/1e3, XY_data(2).bed_tidal_align_smooth_100);
plot(XY_data(3).AT_vel_corrected(1:3769)/1e3, XY_data(3).bed_tidal_align_smooth_100);
plot(XY_data(4).AT_vel_corrected(1:3929)/1e3, XY_data(4).bed_tidal_align_smooth_100);
plot(XY_data(5).AT_vel_corrected(1:4044)/1e3, XY_data(5).bed_tidal_align_smooth_100);
plot(XY_data(6).AT_vel_corrected(1:4101)/1e3, XY_data(6).bed_tidal_align_smooth_100);
ylabel('Elevation WGS (m)');
leg = legend({'2011', '2014', '2015', '2017', '2018', '2019'},'Orientation','Vertical');
leg.Layout.Tile = 'East';
...
han.XLabel.Visible='on';
xlabel(han,'Along Track Distance (km)');
title(han, 'Aligned 100pt Smooth Surface, Bed, and advection-corrected bed');
linkaxes([ax1 ax2 ax3],'x')
grid([ax1 ax2 ax3],'on');

%% 
% smooth 100, 200 and raw
fig = figure(119);
tiledlayout(3,1)
ax1 = nexttile;
plot(XY_data(1).AT_dist(1:3890)/1e3, XY_data(1).surf_tidal_align_smooth_100);
hold on
plot(XY_data(1).AT_dist(1:3890)/1e3, XY_data(1).surf_tidal_align_smooth_200);
plot(XY_data(1).AT_dist(1:3890)/1e3, XY_data(1).surf_tidal_elevation_align(1:3890));
ax1.YLim = [-10 110];
ylabel('Elevation WGS (m)');
...
hold on
plot(XY_data(1).AT_dist(1:3890)/1e3, XY_data(1).bed_tidal_align_smooth_200);
plot(XY_data(1).AT_dist(1:3890)/1e3, XY_data(1).bed_tidal_elevation_align(1:3890));
ylabel('Elevation WGS (m)');
...
hold on
plot(XY_data(1).AT_vel_corrected(1:3890)/1e3, XY_data(1).bed_tidal_align_smooth_200);
plot(XY_data(1).AT_vel_corrected(1:3890)/1e3, XY_data(1).bed_tidal_elevation_align(1:3890));
ylabel('Elevation WGS (m)');
leg = legend({'2011 100pt', '2011 200pt'},'Orientation','Vertical');
leg.Layout.Tile = 'East';
...
han.XLabel.Visible='on';
xlabel(han,'Along Track Distance (km)');
title(han, 'Aligned 2011 100pt, 200pt Smooth, and Raw Surface, Bed, and advection-corrected bed');
linkaxes([ax1 ax2 ax3],'x')
grid([ax1 ax2 ax3],'on');
xlim(ax1,[0 65]);
ylim([ax2 ax3], [-500 0]);
...
%% Fix all problematic divergence value holes in raster with Mean 
% visualize Divergence problematic locations: change variable if you 
% want to plot (0 == no plot, 1 == plot)
plot_val1 = 0;
if plot_val1 == 1
    figure(222)
    plot(XY_data(1).Interp_AT_Dist, XY_data(1).Interp_Div_09_10)
    hold on
    plot(XY_data(1).Interp_AT_Dist, XY_data(1).Interp_Div_12_13)
    plot(XY_data(1).Interp_AT_Dist, XY_data(1).Interp_Div_14_15)
    plot(XY_data(1).Interp_AT_Dist, XY_data(1).Interp_Div_15_16)
    plot(XY_data(1).Interp_AT_Dist, XY_data(1).Interp_Div_16_17)
    plot(XY_data(1).Interp_AT_Dist, XY_data(1).Interp_Div_17_18)
    xlabel('Distance (km)');
    ylabel('Divergence');
else
end

% Loop for indentifying regions where divergence values are greater than 5
for i = 1:numel(XY_data)
    % holes
    holes(i).hole_1_s09_10 = find((XY_data(i).Interp_Div_09_10 >= 5));
    holes(i).hole_1_s12_13 = find((XY_data(i).Interp_Div_12_13 >= 5));
    holes(i).hole_1_s14_15 = find((XY_data(i).Interp_Div_14_15 >= 5));
    holes(i).hole_1_s15_16 = find((XY_data(i).Interp_Div_15_16 >= 5));
    holes(i).hole_1_s16_17 = find((XY_data(i).Interp_Div_16_17 >= 5));
    holes(i).hole_1_s17_18 = find((XY_data(i).Interp_Div_17_18 >= 5));
    
    % mean values after holes used for patching
    mean_patch(i).patch_1_s09_10 = mean(XY_data(i).Interp_Div_09_10(holes(i).hole_1_s09_10(end)+1:end));
    mean_patch(i).patch_1_s12_13 = mean(XY_data(i).Interp_Div_12_13(holes(i).hole_1_s12_13(end)+1:end)); 
    mean_patch(i).patch_1_s14_15 = mean(XY_data(i).Interp_Div_14_15(holes(i).hole_1_s14_15(end)+1:end));
    mean_patch(i).patch_1_s15_16 = mean(XY_data(i).Interp_Div_15_16(holes(i).hole_1_s15_16(end)+1:end));
    mean_patch(i).patch_1_s16_17 = mean(XY_data(i).Interp_Div_16_17(holes(i).hole_1_s16_17(end)+1:end)); 
    mean_patch(i).patch_1_s17_18 = mean(XY_data(i).Interp_Div_17_18(holes(i).hole_1_s17_18(end)+1:end)); 
end

%% FIX DIVERGENCE HOLES WITH PATCH VALUES
for i = 1:numel(XY_data)
    XY_data(i).Interp_Div_09_10(holes(i).hole_1_s09_10) = mean_patch(i).patch_1_s09_10;
    XY_data(i).Interp_Div_12_13(holes(i).hole_1_s12_13) = mean_patch(i).patch_1_s12_13;
    XY_data(i).Interp_Div_14_15(holes(i).hole_1_s14_15) = mean_patch(i).patch_1_s14_15;
    XY_data(i).Interp_Div_15_16(holes(i).hole_1_s15_16) = mean_patch(i).patch_1_s15_16;
    XY_data(i).Interp_Div_16_17(holes(i).hole_1_s16_17) = mean_patch(i).patch_1_s16_17;
    XY_data(i).Interp_Div_17_18(holes(i).hole_1_s17_18) = mean_patch(i).patch_1_s17_18;    
end
% change variable if you want to plot (0 == no plot, 1 == plot)
plot_val2 = 0;
if plot_val2 == 1
    figure(223)
    plot(XY_data(1).Interp_AT_Dist, XY_data(1).Interp_Div_09_10)

%% DYNAMIC VERSION for autoloading all files in Folder - Ryder 1
...
% loop will fail.
file_path = cd('C:\Users\c262b531\Documents\scripts\cresis-toolbox\cresis-toolbox\+multipass\QGIS_processed_DIV_SMB\R1_new_bed\');
myfiles = pwd; 
Velocity_CSV_1 = dir(fullfile(myfiles,'R1M_*.csv'));
    for i = 1:numel(Velocity_CSV_1)
        ...
        XY_data(i).div_12_13_2000m = XY_data(i).data(:,10).';
        XY_data(i).div_14_15_2000m = XY_data(i).data(:,11).';
        XY_data(i).div_15_16_2000m = XY_data(i).data(:,12).';
        XY_data(i).div_16_17_2000m = XY_data(i).data(:,13).';
        XY_data(i).div_17_18_2000m = XY_data(i).data(:,14).';
        XY_data(i).SMB_10 = XY_data(i).data(:,15).';
        XY_data(i).SMB_11 = XY_data(i).data(:,16).';
        XY_data(i).SMB_12 = XY_data(i).data(:,17).';
        XY_data(i).SMB_13 = XY_data(i).data(:,18).';
        XY_data(i).SMB_14 = XY_data(i).data(:,19).';
        XY_data(i).SMB_15 = XY_data(i).data(:,20).';        
        XY_data(i).SMB_16 = XY_data(i).data(:,21).';
        XY_data(i).SMB_17 = XY_data(i).data(:,22).';
        XY_data(i).SMB_18 = XY_data(i).data(:,23).';
        XY_data(i).SMB_19 = XY_data(i).data(:,24).';        
...
title('Ryder uncorrected');
xlabel('distance km');
ylabel('elevation m');
legend('2011','2013','2015','2019','Location','southeast');
%% TIDAL CORRECTIONS
...
% tidal Amplitudes
XY_data(1).mean_tidal_c = (-0.1078 + (-0.1021))/2;
XY_data(2).mean_tidal_c = (-0.1170 + (-0.1161))/2;
XY_data(3).mean_tidal_c = (-0.07000 + (-0.07980))/2;
XY_data(4).mean_tidal_c = (-0.3686 + (-0.02387))/2;
...
for i = 1:4 % define as # of passes or use length(fieldnames(XY_data)) on start 
...
time_offset.P11 = (237/365); % 2011
time_offset.P12 = (366/366); % 2012
time_offset.P13 = (116/365); % 2013
time_offset.P13_2 = (249/365); % 2013 post echogram
time_offset.P14 = (365/365); % 2014
time_offset.P15 = (126/365); % 2015 
time_offset.P15_2 = (239/365); % 2015 post echogram
time_offset.P16 = (366/366); % 2016
time_offset.P17 = (365/365); % 2017
time_offset.P18 = (365/365); % 2018
time_offset.P19 = (113/365); % 2019

% total time offset
time_offset.N_years = (time_offset.P11 + time_offset.P12 + time_offset.P13...
    + time_offset.P13_2 + time_offset.P14 + time_offset.P15 + time_offset.P15_2...
    + time_offset.P16 + time_offset.P17 + time_offset.P18 + time_offset.P19); 
...
for i = 1:numel(XY_data)
    ...
    XY_data(i).SMB_15t = (XY_data(i).Interp_SMB_14*time_offset.P15);
    % 2015 - 2019
    XY_data(i).SMB_15_2t = (XY_data(i).Interp_SMB_14*time_offset.P15_2);
    ...
    XY_data(i).SMB_11_19_mean = (XY_data(i).SMB_11t + XY_data(i).SMB_12t + ...
      XY_data(i).SMB_13t + XY_data(i).SMB_13_2t + XY_data(i).SMB_14t + ...
      XY_data(i).SMB_15t + XY_data(i).SMB_15_2t + XY_data(i).SMB_16t + ...
      XY_data(i).SMB_17t + XY_data(i).SMB_18t + XY_data(i).SMB_19t);
end
%% 5 ICE DIVERGENCE 
for i = 1:numel(XY_data)
    % 2011 - 2013
    XY_data(i).div_11t = (XY_data(i).Interp_Div_12_13*time_offset.P11);
    ...
    XY_data(i).div_11_19_mean = (XY_data(i).div_11t + XY_data(i).div_12t + ...
      XY_data(i).div_13t + XY_data(i).div_13_2t + XY_data(i).div_14t + ...
      XY_data(i).div_15t + XY_data(i).div_15_2t + XY_data(i).div_16t + ...
      XY_data(i).div_17t + XY_data(i).div_18t + XY_data(i).div_19t);
end
...
% Time Offset
XY_data(1).total_time_offset = time_offset.P11 + time_offset.P12 + time_offset.P13;

% SMB
XY_data(1).Mean_SMB = (XY_data(i).SMB_11t + XY_data(1).SMB_12t + XY_data(1).SMB_13t);

% Dynamic Thinning
XY_data(1).Dynamic_component = ((XY_data(1).div_11t + XY_data(1).div_12t + XY_data(1).div_13t)...
    .*XY_data(1).Mean_Thickness);
XY_data(1).Dynamic_component_S150 = ((XY_data(1).div_11t + XY_data(1).div_12t + XY_data(1).div_13t)...
    .*XY_data(1).Mean_Thickness_Smooth150);
XY_data(1).Dynamic_component_S100 = ((XY_data(1).div_11t + XY_data(1).div_12t + XY_data(1).div_13t)...
...
title('Elevation Profiles');
ylabel('elevation (m)');
suptitle('Ryder Line 1 2011-2013')
legend('2011', '2013', 'Location','southeast');
han = axes(fig1,'visible','off');
han.XLabel.Visible ='on';
xlabel(han,'Along Track Distance (km)');

%% 2013 - 2015: Melt, Dynamic Thinning, Mean SMB
% Total Time offset
XY_data(2).total_time_offset = time_offset.P13_2 + time_offset.P14 + time_offset.P15;

% SMB
XY_data(2).Mean_SMB = (XY_data(2).SMB_13_2t + XY_data(2).SMB_14t + XY_data(2).SMB_15t);

% Dynamic Thinning
XY_data(2).Dynamic_component = ((XY_data(2).div_13_2t + XY_data(2).div_14t + XY_data(2).div_15t)...
    .*XY_data(2).Mean_Thickness);
XY_data(2).Dynamic_component_S150 = ((XY_data(2).div_13_2t + XY_data(2).div_14t + XY_data(2).div_15t)...
    .*XY_data(2).Mean_Thickness_Smooth150);
XY_data(2).Dynamic_component_S100 = ((XY_data(2).div_13_2t + XY_data(2).div_14t + XY_data(2).div_15t)...
...
title('Elevation Profiles');
ylabel('elevation (m)');
suptitle('Ryder 1 2013-2015')
legend('2013', '2015', 'Location','southeast');
han = axes(fig2,'visible','off');
han.XLabel.Visible ='on';
xlabel(han,'Along Track Distance (km)');

%% 2015 - 2019: Melt, Dynamic Thinning, Mean SMB
% Time offset
XY_data(3).total_time_offset = time_offset.P15_2 + time_offset.P16 + ...
    time_offset.P17 + time_offset.P18 + time_offset.P19;

% SMB
XY_data(3).Mean_SMB = (XY_data(3).SMB_15_2t + XY_data(1).SMB_16t + ...
    XY_data(1).SMB_17t + XY_data(1).SMB_18t + XY_data(1).SMB_19t);

% Dynamic Thinning
XY_data(3).Dynamic_component = ((XY_data(3).div_15_2t + XY_data(3).div_16t...
    + XY_data(3).div_17t + XY_data(3).div_18t + XY_data(3).div_19t)...
    .*XY_data(3).Mean_Thickness);
XY_data(3).Dynamic_component_S150 = ((XY_data(3).div_15_2t + XY_data(3).div_16t...
    + XY_data(3).div_17t + XY_data(3).div_18t + XY_data(3).div_19t)...
    .*XY_data(3).Mean_Thickness_Smooth150);
XY_data(3).Dynamic_component_S100 = ((XY_data(3).div_15_2t + XY_data(3).div_16t...
    + XY_data(3).div_17t + XY_data(3).div_18t + XY_data(3).div_19t)...
...
title('Elevation Profiles');
ylabel('elevation (m)');
suptitle('Ryder Line 1 2015-2019')
legend('2015', '2019', 'Location','southeast');
...
for j = 1:numel(export_melt_rates)
    name(j).file = append('R1M_melt_E_', string(XY_data(j).year),'_',string(XY_data(j+1).year),'.csv');

%% DYNAMIC VERSION for autoloading all files in Folder - 79N 1
...
% loop will fail.
file_path = cd('C:\Users\c262b531\Documents\scripts\cresis-toolbox\cresis-toolbox\+multipass\QGIS_processed_DIV_SMB\79N1_new_bed\');
myfiles = pwd; 
Velocity_CSV_1 = dir(fullfile(myfiles,'79N1M_*.csv'));
    for i = 1:numel(Velocity_CSV_1)
        ...
        XY_data(i).div_09_10_2000m = XY_data(i).data(:,10).';
        ...
        XY_data(i).SMB_10 = XY_data(i).data(:,16).';
        XY_data(i).SMB_11 = XY_data(i).data(:,17).';
        XY_data(i).SMB_12 = XY_data(i).data(:,18).';
        XY_data(i).SMB_13 = XY_data(i).data(:,19).';
        XY_data(i).SMB_14 = XY_data(i).data(:,20).';
        XY_data(i).SMB_15 = XY_data(i).data(:,21).';        
        XY_data(i).SMB_16 = XY_data(i).data(:,22).';
        XY_data(i).SMB_17 = XY_data(i).data(:,23).';
        XY_data(i).SMB_18 = XY_data(i).data(:,24).';
        XY_data(i).SMB_19 = XY_data(i).data(:,25).';
...
plot(XY_data(4).AT_dist/1e3, XY_data(4).Surf, 'Color','k');
plot(XY_data(4).AT_dist/1e3, XY_data(4).Bed, 'Color','k');
plot(XY_data(5).AT_dist/1e3, XY_data(5).Surf, 'Color','c');
plot(XY_data(5).AT_dist/1e3, XY_data(5).Bed, 'Color','c');
title('79N uncorrected');
xlabel('distance km');
ylabel('elevation m');
legend('2010','2014','2017','2018','2019','Location','southeast');
...
% tidal Amplitudes
XY_data(1).mean_tidal_c = (0.06008 + 0.08819)/2;
XY_data(2).mean_tidal_c = (0.2194 + 0.2353)/2;
XY_data(3).mean_tidal_c = (0.1268 + 0.0846)/2;
XY_data(4).mean_tidal_c = (0.2359 + 0.2261)/2;
XY_data(5).mean_tidal_c = (-0.251 + (-0.2369))/2;
%XY_data(6).mean_tidal_c = (-0.2591 + (-0.2503))/2;

% Extract Ocean Surface with tidal correction, set to 0 tidal level
XY_data(1).ocean_surface = XY_data(1).Surf(4362:end) - XY_data(3).mean_tidal_c; %was 4363
XY_data(2).ocean_surface = XY_data(2).Surf(4440:end) - XY_data(3).mean_tidal_c; %was 4441
XY_data(3).ocean_surface = XY_data(3).Surf(4229:end) - XY_data(3).mean_tidal_c; %was 4228
XY_data(4).ocean_surface = XY_data(4).Surf(4220:end) - XY_data(4).mean_tidal_c; %was 4208
XY_data(5).ocean_surface = XY_data(5).Surf(4230:end) + XY_data(5).mean_tidal_c; %was 4235
%XY_data(6).ocean_surface = XY_data(6).Surf(3569:end) + XY_data(6).mean_tidal_c;

% Extract AT array for each ocean surface, set to 0 tidal level
XY_data(1).AT_ocean = XY_data(1).AT_dist(4362:end); 
XY_data(2).AT_ocean = XY_data(2).AT_dist(4440:end);
XY_data(3).AT_ocean = XY_data(3).AT_dist(4229:end);
XY_data(4).AT_ocean = XY_data(4).AT_dist(4220:end);
XY_data(5).AT_ocean = XY_data(5).AT_dist(4230:end);
%XY_data(6).AT_ocean = XY_data(6).AT_dist(3516:end);
...
plot(XY_data(1).AT_dist/1e3, XY_data(4).surf_tidal_elevation_align, 'Color','k');
plot(XY_data(1).AT_dist/1e3, XY_data(4).bed_tidal_elevation_align, 'Color','k');
plot(XY_data(1).AT_dist/1e3, XY_data(5).surf_tidal_elevation_align, 'Color','c');
plot(XY_data(1).AT_dist/1e3, XY_data(5).bed_tidal_elevation_align, 'Color','c');
% plot(XY_data(1).AT_dist/1e3, XY_data(6).surf_tidal_elevation_align, 'Color','m');
% plot(XY_data(1).AT_dist/1e3, XY_data(6).bed_tidal_elevation_align, 'Color','m');
legend show

figure(117)
plot(XY_data(1).AT_dist/1e3 + XY_data(1).Vel_mag/1e3, XY_data(1).surf_tidal_elevation_align, 'Color','r');
hold on 
plot(XY_data(1).AT_dist/1e3 + XY_data(1).Vel_mag/1e3, XY_data(1).bed_tidal_elevation_align, 'Color','r');
plot(XY_data(2).AT_dist/1e3 + XY_data(2).Vel_mag/1e3, XY_data(2).surf_tidal_elevation_align, 'Color','g');
plot(XY_data(2).AT_dist/1e3 + XY_data(2).Vel_mag/1e3, XY_data(2).bed_tidal_elevation_align, 'Color','g');
plot(XY_data(3).AT_dist/1e3 + XY_data(3).Vel_mag/1e3, XY_data(3).surf_tidal_elevation_align, 'Color','b');
plot(XY_data(3).AT_dist/1e3 + XY_data(3).Vel_mag/1e3, XY_data(3).bed_tidal_elevation_align, 'Color','b');
plot(XY_data(4).AT_dist/1e3 + XY_data(4).Vel_mag/1e3, XY_data(4).surf_tidal_elevation_align, 'Color','k');
plot(XY_data(4).AT_dist/1e3 + XY_data(4).Vel_mag/1e3, XY_data(4).bed_tidal_elevation_align, 'Color','k');
plot(XY_data(5).AT_dist/1e3 + XY_data(5).Vel_mag/1e3, XY_data(5).surf_tidal_elevation_align, 'Color','c');
plot(XY_data(5).AT_dist/1e3 + XY_data(5).Vel_mag/1e3, XY_data(5).bed_tidal_elevation_align, 'Color','c');
% plot(XY_data(6).AT_dist/1e3, XY_data(6).surf_tidal_elevation_align, 'Color','m');
% plot(XY_data(6).AT_dist/1e3, XY_data(6).bed_tidal_elevation_align, 'Color','m');
legend show
...
time_offset.P10 = (221/365); % 2010 
time_offset.P11 = (365/365); % 2011 
time_offset.P12 = (366/366); % 2012
time_offset.P13 = (365/365); % 2013
time_offset.P14 = (118/365); % 2014
time_offset.P14_2 = (247/365); % 2014 post echogram
time_offset.P15 = (365/365); % 2015 
time_offset.P16 = (129/366); % 2016 
time_offset.P16_2 = (237/366); % 2016 post echogram
time_offset.P17 = (92/365); % 2017
time_offset.P17_2 = (273/365); % 2017 post echogram
time_offset.P18 = (107/365); % 2018
time_offset.P18_2 = (258/365); % 2018 post echogram
time_offset.P19 = (95/365); % 2019

% total time offset
time_offset.N_years = (time_offset.P10 + time_offset.P11 + time_offset.P12 + ...
    time_offset.P13 + time_offset.P14 + time_offset.P14_2 + time_offset.P15 + ...
    time_offset.P16 + time_offset.P16_2 + time_offset.P17 + time_offset.P17_2 ...
    + time_offset.P18 + time_offset.P18_2 + time_offset.P19); 

%% SMB 
% Surface Mass Balance Correction and Firn correction
for i = 1:numel(XY_data)
    % 2010 - 2014
    XY_data(i).SMB_10t = (XY_data(i).Interp_SMB_10*time_offset.P10);
    ...
    %2011 - 2019 mean
    XY_data(i).SMB_10_19_mean = (XY_data(i).SMB_10t + XY_data(i).SMB_11t + ...
      XY_data(i).SMB_12t + XY_data(i).SMB_13t + XY_data(i).SMB_14t + ...
      XY_data(i).SMB_14_2t + XY_data(i).SMB_15t + XY_data(i).SMB_16t + ...
      XY_data(i).SMB_16_2t + XY_data(i).SMB_17t + XY_data(i).SMB_17_2t + ...
      XY_data(i).SMB_18t + XY_data(i).SMB_18_2t + XY_data(i).SMB_19t);
...
%% Fix Inter_Div_14_15 holes in raster with Mean 
% Figure to Identify Divergence probelm locations
% change to the year you want, and also the index in structure
figure(222)
plot(XY_data(2).Interp_AT_Dist, XY_data(2).Interp_Div_14_15)
xlabel('Distance (km)');
ylabel('Divergence');

% define indices of the array holes
XY_data(1).hole_1_14t = (2011:2728);
XY_data(1).hole_2_14t = (2823:3217);
XY_data(1).hole_3_14t = (3399:3519);
XY_data(1).hole_4_14t = (3580:3582);

XY_data(2).hole_1_14t = (1832:2606);
XY_data(2).hole_2_14t = (2706:3115);
XY_data(2).hole_3_14t = (3298:3416);
XY_data(2).hole_4_14t = (3481:3582);
% define the mean values of non-hole locations downflow for fixing holes
XY_data(1).Mean_1_14t = mean(XY_data(1).Interp_Div_14_15(2729:2822));
XY_data(1).Mean_2_14t = mean(XY_data(1).Interp_Div_14_15(3218:3398));
XY_data(1).Mean_3_14t = mean(XY_data(1).Interp_Div_14_15(3520:3579));

XY_data(2).Mean_1_14t = mean(XY_data(2).Interp_Div_14_15(2607:2705));
XY_data(2).Mean_2_14t = mean(XY_data(2).Interp_Div_14_15(3116:3297));
XY_data(2).Mean_3_14t = mean(XY_data(2).Interp_Div_14_15(3417:3480));
% Take hole indices
XY_data(1).Interp_Div_14_15(XY_data(1).hole_1_14t) = XY_data(1).Mean_1_14t;
XY_data(1).Interp_Div_14_15(XY_data(1).hole_2_14t) = XY_data(1).Mean_2_14t;
XY_data(1).Interp_Div_14_15(XY_data(1).hole_3_14t) = XY_data(1).Mean_3_14t;
XY_data(1).Interp_Div_14_15(XY_data(1).hole_4_14t) = XY_data(1).Mean_3_14t;

XY_data(2).Interp_Div_14_15(XY_data(2).hole_1_14t) = XY_data(2).Mean_1_14t;
XY_data(2).Interp_Div_14_15(XY_data(2).hole_2_14t) = XY_data(2).Mean_2_14t;
XY_data(2).Interp_Div_14_15(XY_data(2).hole_3_14t) = XY_data(2).Mean_3_14t;
XY_data(2).Interp_Div_14_15(XY_data(2).hole_4_14t) = XY_data(2).Mean_3_14t;
% Test Figure
figure(223)
plot(XY_data(2).Interp_AT_Dist, XY_data(2).Interp_Div_14_15)
xlabel('Distance (km)');
...
for i = 1:numel(XY_data)
    % 2010 - 2014
    XY_data(i).div_10t = (XY_data(i).Interp_Div_09_10*time_offset.P10);
    ...
    % 2016 - 2017
    XY_data(i).div_16_2t = (XY_data(i).Interp_Div_16_17*time_offset.P16_2);
    ...
    %2010 - 2019 mean
    XY_data(i).div_10_19_mean = (XY_data(i).div_10t + XY_data(i).div_11t + ...
        XY_data(i).div_12t + XY_data(i).div_13t + XY_data(i).div_14t + ...
        XY_data(i).div_14_2t + XY_data(i).div_15t + XY_data(i).div_16t + ...
        XY_data(i).div_16_2t + XY_data(i).div_17t + XY_data(i).div_17_2t + ...
        XY_data(i).div_18t + XY_data(i).div_18_2t + XY_data(i).div_19t);
end
...
%% ANNUAL MELT RATES 
% 2010 - 2014: Melt, Dynamic Thinning, Mean SMB
% Time Offset
XY_data(1).total_time_offset = time_offset.P10 + time_offset.P11 + ...
    time_offset.P12 + time_offset.P13 + time_offset.P14;

% SMB
XY_data(1).Mean_SMB = (XY_data(i).SMB_10t + XY_data(1).SMB_11t + ...
    XY_data(i).SMB_12t + XY_data(i).SMB_13t + XY_data(i).SMB_14t);

% Dynamic Thinning
XY_data(1).Dynamic_component = ((XY_data(1).div_10t + XY_data(1).div_11t + ...
    XY_data(1).div_12t + XY_data(1).div_13t + XY_data(1).div_14t)...
    .*XY_data(1).Mean_Thickness);
XY_data(1).Dynamic_component_S150 = ((XY_data(1).div_10t + XY_data(1).div_11t + ...
    XY_data(1).div_12t + XY_data(1).div_13t + XY_data(1).div_14t)...
    .*XY_data(1).Mean_Thickness_Smooth150);
XY_data(1).Dynamic_component_S100 = ((XY_data(1).div_10t + XY_data(1).div_11t + ...
    XY_data(1).div_12t + XY_data(1).div_13t + XY_data(1).div_14t)...
    .*XY_data(1).Mean_Thickness_Smooth100);

% Total Melt
XY_data(1).Melt_SMB = ((XY_data(1).Interp_Thickness - XY_data(1).Firn_thickness) - (XY_data(2).Interp_Thickness - XY_data(2).Firn_thickness)) - XY_data(1).Dynamic_component - XY_data(1).Mean_SMB;

% Annual Melt 
XY_data(1).Melt_SMB_yr = (((XY_data(1).Interp_Thickness - XY_data(1).Firn_thickness) - (XY_data(2).Interp_Thickness - XY_data(2).Firn_thickness)) - XY_data(1).Dynamic_component - XY_data(1).Mean_SMB)...
...
% Hydrostatic 
XY_data(1).Hydro_thickness = (((XY_data(1).Interp_Surf_Corrected - XY_data(1).Firn_thickness)*1027)/(1027-917));
XY_data(2).Hydro_thickness = (((XY_data(2).Interp_Surf_Corrected - XY_data(1).Firn_thickness)*1027)/(1027-917));
XY_data(1).Hydro_bed = -(XY_data(1).Hydro_thickness - XY_data(1).Interp_Surf);
XY_data(2).Hydro_bed = -(XY_data(2).Hydro_thickness - XY_data(2).Interp_Surf);
XY_data(1).Hydro_dynamic_component = ((XY_data(1).div_10t + XY_data(1).div_11t + ...
    XY_data(1).div_12t + XY_data(1).div_13t + XY_data(1).div_14t)...
    .*XY_data(1).Hydro_thickness);
XY_data(1).Hydro_melt_total = (XY_data(1).Hydro_thickness - XY_data(2).Hydro_thickness) - ...
    XY_data(1).Hydro_dynamic_component - XY_data(1).Mean_SMB;
XY_data(1).Hydro_melt_yr = XY_data(1).Hydro_melt_total/XY_data(1).total_time_offset;

fig1_1 = figure(996);
subplot(2,1,1)
plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(1).Melt_SMB_yr);
hold on 
plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(1).Hydro_melt_yr);
ylabel('Basal Melt (m)');
ylim([-75 75]);
title('Annual Basal Melt');
legend('Mean annual melt','hydro annual melt', 'Location','southeast');
subplot(2,1,2)
plot(XY_data(1).Interp_AT_Dist/1e3 + XY_data(1).Interp_Vel_mag/1e3, XY_data(1).Interp_Surf_Corrected, 'color','r');
hold on
plot(XY_data(2).Interp_AT_Dist/1e3 + XY_data(2).Interp_Vel_mag/1e3, XY_data(2).Interp_Surf_Corrected, 'color','b');
plot(XY_data(1).Interp_AT_Dist/1e3 + XY_data(1).Interp_Vel_mag/1e3, XY_data(1).Hydro_bed, 'color','g');
plot(XY_data(2).Interp_AT_Dist/1e3 + XY_data(2).Interp_Vel_mag/1e3, XY_data(2).Hydro_bed, 'color','k');
plot(XY_data(1).Interp_AT_Dist/1e3 + XY_data(1).Interp_Vel_mag/1e3, XY_data(1).Interp_Bed_Corrected, 'color','r');
plot(XY_data(2).Interp_AT_Dist/1e3 + XY_data(2).Interp_Vel_mag/1e3, XY_data(2).Interp_Bed_Corrected, 'color','b');
title('Elevation Profiles');
ylabel('elevation (m)');
suptitle('79N Line 1 2010-2014')
legend('2010', '2014', 'Hydrostatic 2010', 'Hydrostatic 2014','Location','southeast');
han = axes(fig1_1,'visible','off');
han.XLabel.Visible ='on';
xlabel(han,'Along Track Distance (km)');

fig1 = figure(101);
subplot(5,1,1)
plot(XY_data(1).Interp_AT_Dist/1e3,  XY_data(1).Mean_SMB/XY_data(1).total_time_offset);
ylim([-2.5 0]);
ylabel('SMB (m/yr)');
title('Mean SMB')
legend('Mean SMB','Location','eastoutside');
subplot(5,1,2)
plot(XY_data(1).Interp_AT_Dist/1e3,  XY_data(1).Dynamic_component/XY_data(1).total_time_offset);
hold on
plot(XY_data(1).Interp_AT_Dist/1e3,  XY_data(1).Dynamic_component_S150/XY_data(1).total_time_offset);
plot(XY_data(1).Interp_AT_Dist/1e3,  XY_data(1).Dynamic_component_S100/XY_data(1).total_time_offset);
ylim([-10 10]);
ylabel('Thinning Rate (m/yr)');
title('Mean Dynamic Thinning')
legend('Mean Div','150pt smoot','100pt smooth','Location','eastoutside');
subplot(5,1,3)
plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(1).Melt_SMB);
%ylim([-10 100]);
ylabel('Basal Melt (m)');
title('Total Basal Melt');
legend('Mean Melt','Location','eastoutside');
subplot(5,1,4)
plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(1).Melt_SMB_yr);
hold on
...
ylabel('Basal Melt (m)');
title('Annual Basal Melt');
legend('Annual Melt','150pt smooth','100pt smooth','Location','eastoutside');
subplot(5,1,5)
...
ylabel('elevation (m)');
suptitle('79N Line 1 2010-2014')
legend('2010', '2014', 'Location','southeast');
...
% Total Time offset
XY_data(2).total_time_offset = time_offset.P14_2 + time_offset.P15 + time_offset.P16;

% SMB
XY_data(2).Mean_SMB = (XY_data(2).SMB_14_2t + XY_data(2).SMB_15t + XY_data(2).SMB_16t);

% Dynamic Thinning
XY_data(2).Dynamic_component = ((XY_data(2).div_14_2t + XY_data(2).div_15t + XY_data(2).div_16t)...
    .*XY_data(2).Mean_Thickness);
XY_data(2).Dynamic_component_S150 = ((XY_data(2).div_14_2t + XY_data(2).div_15t + XY_data(2).div_16t)...
    .*XY_data(2).Mean_Thickness_Smooth150);
XY_data(2).Dynamic_component_S100 = ((XY_data(2).div_14_2t + XY_data(2).div_15t + XY_data(2).div_16t)...
    .*XY_data(2).Mean_Thickness_Smooth100);

% Total Melt
XY_data(2).Melt_SMB = ((XY_data(2).Interp_Thickness- XY_data(2).Firn_thickness) - (XY_data(3).Interp_Thickness- XY_data(3).Firn_thickness)) - XY_data(2).Dynamic_component - XY_data(2).Mean_SMB;

% Annual Melt 
XY_data(2).Melt_SMB_yr = (((XY_data(2).Interp_Thickness - XY_data(2).Firn_thickness) - (XY_data(3).Interp_Thickness- XY_data(3).Firn_thickness)) - XY_data(2).Dynamic_component - XY_data(2).Mean_SMB)...
    /XY_data(2).total_time_offset;
XY_data(2).Melt_SMB_smooth150_yr = (((XY_data(2).Interp_Thickness_Smooth_150 - XY_data(2).Firn_thickness) - (XY_data(3).Interp_Thickness_Smooth_150 - XY_data(3).Firn_thickness)) - XY_data(2).Dynamic_component_S150 - XY_data(2).Mean_SMB)...
    /XY_data(2).total_time_offset;
XY_data(2).Melt_SMB_smooth100_yr = (((XY_data(2).Interp_Thickness_Smooth_100 - XY_data(2).Firn_thickness) - (XY_data(3).Interp_Thickness_Smooth_100 - XY_data(3).Firn_thickness)) - XY_data(2).Dynamic_component_S100 - XY_data(2).Mean_SMB)...
    /XY_data(2).total_time_offset;

% Hydrostatic 
firn_depth = 0;
XY_data(2).Hydro_thickness = (((XY_data(2).Interp_Surf_Corrected - XY_data(2).Firn_thickness)*1027)/(1027-917));
XY_data(3).Hydro_thickness = (((XY_data(3).Interp_Surf_Corrected - XY_data(3).Firn_thickness)*1027)/(1027-917));
XY_data(2).Hydro_bed = -(XY_data(2).Hydro_thickness - XY_data(2).Interp_Surf);
XY_data(3).Hydro_bed = -(XY_data(3).Hydro_thickness - XY_data(3).Interp_Surf);
XY_data(2).Hydro_dynamic_component = ((XY_data(2).div_14_2t + XY_data(2).div_15t + XY_data(2).div_16t)...
    .*XY_data(2).Hydro_thickness);
XY_data(2).Hydro_melt_total = (XY_data(2).Hydro_thickness - XY_data(3).Hydro_thickness) - ...
    XY_data(2).Hydro_dynamic_component - XY_data(2).Mean_SMB;
XY_data(2).Hydro_melt_yr = XY_data(2).Hydro_melt_total/XY_data(2).total_time_offset;

fig2_1 = figure(997);
subplot(2,1,1)
plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(2).Melt_SMB_yr);
hold on 
plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(2).Hydro_melt_yr);
ylabel('Basal Melt (m)');
ylim([-75 75]);
title('Annual Basal Melt');
legend('Mean annual melt','hydro annual melt', 'Location','southeast');
subplot(2,1,2)
plot(XY_data(2).Interp_AT_Dist/1e3 + XY_data(2).Interp_Vel_mag/1e3, XY_data(2).Interp_Surf_Corrected, 'color','r');
hold on
plot(XY_data(3).Interp_AT_Dist/1e3 + XY_data(3).Interp_Vel_mag/1e3, XY_data(3).Interp_Surf_Corrected, 'color','b');
plot(XY_data(2).Interp_AT_Dist/1e3 + XY_data(2).Interp_Vel_mag/1e3, XY_data(2).Hydro_bed, 'color','g');
plot(XY_data(3).Interp_AT_Dist/1e3 + XY_data(3).Interp_Vel_mag/1e3, XY_data(3).Hydro_bed, 'color','k');
plot(XY_data(2).Interp_AT_Dist/1e3 + XY_data(2).Interp_Vel_mag/1e3, XY_data(2).Interp_Bed_Corrected, 'color','r');
plot(XY_data(3).Interp_AT_Dist/1e3 + XY_data(3).Interp_Vel_mag/1e3, XY_data(3).Interp_Bed_Corrected, 'color','b');
title('Elevation Profiles');
ylabel('elevation (m)');
suptitle('79N Line 1 2014-2017')
legend('2014', '2017', 'Hydrostatic 2014', 'Hydrostatic 2017','Location','southeast');
han = axes(fig2_1,'visible','off');
han.XLabel.Visible ='on';
xlabel(han,'Along Track Distance (km)');

fig2 = figure(102);
subplot(5,1,1)
plot(XY_data(2).Interp_AT_Dist/1e3,  XY_data(2).Mean_SMB/XY_data(2).total_time_offset);
ylim([-2.5 0]);
ylabel('SMB (m/yr)');
title('Mean SMB')
legend('Mean SMB','Location','eastoutside');
subplot(5,1,2)
plot(XY_data(1).Interp_AT_Dist/1e3,  XY_data(2).Dynamic_component/XY_data(2).total_time_offset);
hold on
plot(XY_data(1).Interp_AT_Dist/1e3,  XY_data(2).Dynamic_component_S150/XY_data(2).total_time_offset);
plot(XY_data(1).Interp_AT_Dist/1e3,  XY_data(2).Dynamic_component_S100/XY_data(2).total_time_offset);
ylim([-10 10]);
ylabel('Thinning Rate (m/yr)');
title('Mean Dynamic Thinning')
legend('Mean Div','150pt smoot','100pt smooth','Location','eastoutside');
...
% Time offset
XY_data(3).total_time_offset = time_offset.P16_2 + time_offset.P17;

% SMB
XY_data(3).Mean_SMB = (XY_data(3).SMB_16_2t + XY_data(3).SMB_17t);

% Dynamic Thinning
XY_data(3).Dynamic_component = ((XY_data(3).div_16_2t + XY_data(3).div_17t)...
    .*XY_data(3).Mean_Thickness);
XY_data(3).Dynamic_component_S150 = ((XY_data(3).div_16_2t + XY_data(3).div_17t)...
    .*XY_data(3).Mean_Thickness_Smooth150);
XY_data(3).Dynamic_component_S100 = ((XY_data(3).div_16_2t + XY_data(3).div_17t)...
...
% Hydrostatic 
firn_depth = 0;
XY_data(3).Hydro_thickness = (((XY_data(3).Interp_Surf_Corrected - XY_data(1).Firn_thickness)*1027)/(1027-917));
XY_data(4).Hydro_thickness = (((XY_data(4).Interp_Surf_Corrected - XY_data(1).Firn_thickness)*1027)/(1027-917));
XY_data(3).Hydro_bed = -(XY_data(3).Hydro_thickness - XY_data(3).Interp_Surf);
XY_data(4).Hydro_bed = -(XY_data(4).Hydro_thickness - XY_data(4).Interp_Surf);
XY_data(3).Hydro_dynamic_component = ((XY_data(3).div_16_2t + XY_data(3).div_17t).*XY_data(3).Hydro_thickness);
XY_data(3).Hydro_melt_total = (XY_data(3).Hydro_thickness - XY_data(4).Hydro_thickness) - ...
    XY_data(3).Hydro_dynamic_component - XY_data(3).Mean_SMB;
XY_data(3).Hydro_melt_yr = XY_data(3).Hydro_melt_total/XY_data(3).total_time_offset;
...
hold on 
plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(3).Hydro_melt_yr);
ylabel('Basal Melt (m)');
title('Annual Basal Melt');
ylim([-75 75]);
legend('Mean annual melt','hydro annual melt', 'Location','southeast');
subplot(2,1,2)
plot(XY_data(3).Interp_AT_Dist/1e3 + XY_data(3).Interp_Vel_mag/1e3, XY_data(3).Interp_Surf_Corrected, 'color','r');
hold on
plot(XY_data(4).Interp_AT_Dist/1e3 + XY_data(4).Interp_Vel_mag/1e3, XY_data(4).Interp_Surf_Corrected, 'color','b');
plot(XY_data(3).Interp_AT_Dist/1e3 + XY_data(3).Interp_Vel_mag/1e3, XY_data(3).Hydro_bed, 'color','g');
plot(XY_data(4).Interp_AT_Dist/1e3 + XY_data(4).Interp_Vel_mag/1e3, XY_data(4).Hydro_bed, 'color','k');
plot(XY_data(3).Interp_AT_Dist/1e3 + XY_data(3).Interp_Vel_mag/1e3, XY_data(3).Interp_Bed_Corrected, 'color','r');
plot(XY_data(4).Interp_AT_Dist/1e3 + XY_data(4).Interp_Vel_mag/1e3, XY_data(4).Interp_Bed_Corrected, 'color','b');
title('Elevation Profiles');
ylabel('elevation (m)');
suptitle('79N Line 1 2017-2018')
legend('2017', '2018', 'Hydrostatic 2017', 'Hydrostatic 2018','Location','southeast');
han = axes(fig3_1,'visible','off');
han.XLabel.Visible ='on';
xlabel(han,'Along Track Distance (km)');

fig3 = figure(103);
subplot(5,1,1)
plot(XY_data(1).Interp_AT_Dist/1e3,  XY_data(3).Mean_SMB/XY_data(3).total_time_offset);
ylim([-2.5 0]);
ylabel('SMB (m/yr)');
title('Mean SMB')
legend('Time offset','Location','eastoutside');
subplot(5,1,2)
plot(XY_data(1).Interp_AT_Dist/1e3,  XY_data(3).Dynamic_component/XY_data(3).total_time_offset);
hold on
plot(XY_data(1).Interp_AT_Dist/1e3,  XY_data(3).Dynamic_component_S150/XY_data(3).total_time_offset);
plot(XY_data(1).Interp_AT_Dist/1e3,  XY_data(3).Dynamic_component_S100/XY_data(3).total_time_offset);
ylim([-10 10]);
ylabel('Thinning Rate (m/yr)');
title('Mean Dynamic Thinning')
legend('Mean Div','150pt smoot','100pt smooth','Location','eastoutside');
...
title('Elevation Profiles');
ylabel('elevation (m)');
suptitle('79N Line 1 2016-2017')
legend('2016', '2017', 'Location','southeast');
...
% SMB
XY_data(4).Mean_SMB = (XY_data(4).SMB_17_2t + XY_data(4).SMB_18t);

% Dynamic Thinning
XY_data(4).Dynamic_component = ((XY_data(4).div_17_2t + XY_data(4).div_18t)...
    .*XY_data(4).Mean_Thickness);
XY_data(4).Dynamic_component_S150 = ((XY_data(4).div_17_2t + XY_data(4).div_18t)...
    .*XY_data(4).Mean_Thickness_Smooth150);
XY_data(4).Dynamic_component_S100 = ((XY_data(4).div_17_2t + XY_data(4).div_18t)...
...
firn_depth = 0;
XY_data(4).Hydro_thickness = (((XY_data(4).Interp_Surf_Corrected - XY_data(1).Firn_thickness)*1027)/(1027-917));
XY_data(5).Hydro_thickness = (((XY_data(5).Interp_Surf_Corrected - XY_data(1).Firn_thickness)*1027)/(1027-917));
XY_data(4).Hydro_bed = -(XY_data(4).Hydro_thickness - XY_data(4).Interp_Surf);
XY_data(5).Hydro_bed = -(XY_data(5).Hydro_thickness - XY_data(5).Interp_Surf);
XY_data(4).Hydro_dynamic_component = ((XY_data(4).div_17_2t + XY_data(4).div_18t).*XY_data(4).Hydro_thickness);
XY_data(4).Hydro_melt_total = (XY_data(4).Hydro_thickness - XY_data(5).Hydro_thickness) - ...
    XY_data(4).Hydro_dynamic_component - XY_data(4).Mean_SMB;
XY_data(4).Hydro_melt_yr = XY_data(4).Hydro_melt_total/XY_data(4).total_time_offset;
...
hold on 
plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(4).Hydro_melt_yr);
ylabel('Basal Melt (m)');
title('Annual Basal Melt');
ylim([-75 75]);
legend('Mean annual melt','hydro annual melt', 'Location','southeast');
subplot(2,1,2)
plot(XY_data(4).Interp_AT_Dist/1e3 + XY_data(4).Interp_Vel_mag/1e3, XY_data(4).Interp_Surf_Corrected, 'color','r');
hold on
plot(XY_data(5).Interp_AT_Dist/1e3 + XY_data(5).Interp_Vel_mag/1e3, XY_data(5).Interp_Surf_Corrected, 'color','b');
plot(XY_data(4).Interp_AT_Dist/1e3 + XY_data(4).Interp_Vel_mag/1e3, XY_data(4).Hydro_bed, 'color','g');
plot(XY_data(4).Interp_AT_Dist/1e3 + XY_data(4).Interp_Vel_mag/1e3, XY_data(5).Hydro_bed, 'color','k');
plot(XY_data(4).Interp_AT_Dist/1e3 + XY_data(4).Interp_Vel_mag/1e3, XY_data(4).Interp_Bed_Corrected, 'color','r');
plot(XY_data(5).Interp_AT_Dist/1e3 + XY_data(5).Interp_Vel_mag/1e3, XY_data(5).Interp_Bed_Corrected, 'color','b');
title('Elevation Profiles');
ylabel('elevation (m)');
suptitle('79N Line 1 2018-2019')
legend('2018', '2019', 'Hydrostatic 2018', 'Hydrostatic 2019','Location','southeast');
...
fig4 = figure(104);
subplot(5,1,1)
plot(XY_data(1).Interp_AT_Dist/1e3,  XY_data(4).Mean_SMB/XY_data(4).total_time_offset);
ylim([-2.5 0]);
ylabel('SMB (m/yr)');
title('Mean SMB')
legend('Time offset','Location','eastoutside');
subplot(5,1,2)
plot(XY_data(1).Interp_AT_Dist/1e3,  XY_data(4).Dynamic_component/XY_data(4).total_time_offset);
hold on
plot(XY_data(1).Interp_AT_Dist/1e3,  XY_data(4).Dynamic_component_S150/XY_data(4).total_time_offset);
plot(XY_data(1).Interp_AT_Dist/1e3,  XY_data(4).Dynamic_component_S100/XY_data(4).total_time_offset);
ylim([-10 10]);
ylabel('Thinning Rate (m/yr)');
title('Mean Dynamic Thinning')
legend('Mean Div','150pt smoot','100pt smooth','Location','eastoutside');
...
% Dynamic Thinning
XY_data(5).Dynamic_component = ((XY_data(5).div_18_2t + XY_data(5).div_19t)...
    .*XY_data(5).Mean_Thickness);
XY_data(5).Dynamic_component_S150 = ((XY_data(5).div_18_2t + XY_data(5).div_19t)...
    .*XY_data(5).Mean_Thickness_Smooth150);
XY_data(5).Dynamic_component_S100 = ((XY_data(5).div_18_2t + XY_data(5).div_19t)...
    .*XY_data(5).Mean_Thickness_Smooth100);
...
fig5 = figure(105);
subplot(5,1,1)
plot(XY_data(1).Interp_AT_Dist/1e3,  XY_data(5).Mean_SMB);
ylim([-2.5 0]);
ylabel('SMB (m/yr)');
title('Mean SMB')
legend('Time offset','Location','eastoutside');
subplot(5,1,2)
plot(XY_data(1).Interp_AT_Dist/1e3,  XY_data(5).Dynamic_component);
ylim([-20 10]);
ylabel('Thinning Rate (m/yr)');
title('Mean Dynamic Thinning')
legend('Time offset','Location','eastoutside');
subplot(5,1,3)
plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(5).Melt_SMB);
ylim([-20 200]);
ylabel('Basal Melt (m)');
title('Total Basal Melt');
legend('Time offset thickness','Location','eastoutside');
...
ylabel('elevation (m)');
suptitle('79N Line 1 2018-2019')
legend('2019', '2019', 'Location','southeast');
han = axes(fig3,'visible','off');
han.XLabel.Visible ='on';
xlabel(han,'Along Track Distance (km)');
...
for j = 1:numel(export_melt_rates)
    name(j).file = append('79N1M_melt_E_', string(XY_data(j).year),'_',string(XY_data(j+1).year),'.csv');

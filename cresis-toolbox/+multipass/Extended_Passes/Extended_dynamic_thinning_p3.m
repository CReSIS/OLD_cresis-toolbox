...
myfiles = pwd; 
Velocity_CSV_1 = dir(fullfile(myfiles,'P4E_*.csv'));
    for i = 1:numel(Velocity_CSV_1)
        ...
        XY_data(i).SMB_17 = XY_data(i).data(:,14).';        
...
% tidal Amplitudes
XY_data(1).mean_tidal_c = (-0.831675 + -(0.9486))/2;
XY_data(2).mean_tidal_c = (.29955 + .2885 + .311475)/3 ;
XY_data(3).mean_tidal_c = (-2.1155 + (-2.077))/2;
XY_data(4).mean_tidal_c = (2.38425 + 2.4605)/2;
XY_data(5).mean_tidal_c = (0.37905 + .3535)/2;
...
myfiles = pwd; 
Velocity_CSV_2 = dir(fullfile(myfiles,'P4_pass_1*_mean.csv'));
...
XY_data(4).ocean_surface = XY_data(4).Surf(3569:end) - XY_data(3).mean_tidal_c;
XY_data(5).ocean_surface = XY_data(5).Surf(3795:end) - XY_data(3).mean_tidal_c;
...
XY_data(4).AT_ocean = XY_data(4).AT_dist(3516:end);
XY_data(5).AT_ocean = XY_data(5).AT_dist(3795:end);
...
for i = 1:5 % define as # of passes or use length(fieldnames(XY_data)) on start 
...
for i = 1:5
   ...
   XY_data(i).Interp_Div_09_10 = interp1(XY_data(i).Ending_clip,...
       XY_data(i).div_09_10_2000m_End, XY_data(1).query_array, 'nearest','extrap');
   ...
   XY_data(i).Interp_SMB_10 = interp1(XY_data(i).Ending_clip,...
       XY_data(i).SMB_10_End, XY_data(1).query_array, 'nearest','extrap');   
   
   XY_data(i).Interp_SMB_11 = interp1(XY_data(i).Ending_clip,...
       XY_data(i).SMB_11_End, XY_data(1).query_array, 'nearest','extrap');
   
   XY_data(i).Interp_SMB_12 = interp1(XY_data(i).Ending_clip,...
       XY_data(i).SMB_12_End, XY_data(1).query_array, 'nearest','extrap');
   
   XY_data(i).Interp_SMB_13 = interp1(XY_data(i).Ending_clip,...
       XY_data(i).SMB_13_End, XY_data(1).query_array, 'nearest','extrap');   
   
   XY_data(i).Interp_SMB_14 = interp1(XY_data(i).Ending_clip,...
       XY_data(i).SMB_14_End, XY_data(1).query_array, 'nearest','extrap');
   ...
   XY_data(i).Interp_SMB_16 = interp1(XY_data(i).Ending_clip,...
       XY_data(i).SMB_16_End, XY_data(1).query_array, 'nearest','extrap');
   
   XY_data(i).Interp_SMB_17 = interp1(XY_data(i).Ending_clip,...
       XY_data(i).SMB_17_End, XY_data(1).query_array, 'nearest','extrap');
   
   XY_data(i).Interp_Surf_Corrected = interp1(XY_data(i).Ending_clip,...
        XY_data(i).Surf_tidal_elevation_align_End, XY_data(1).query_array, 'nearest','extrap');
    
   XY_data(i).Interp_Bed_Corrected = interp1(XY_data(i).Ending_clip,...
        XY_data(i).Bed_tidal_elevation_align_End, XY_data(1).query_array, 'nearest','extrap');
end
...
time_offset.P10 = (283/365); % 2010
time_offset.P11 = (126/365); % 2011
time_offset.P11_2 = (239/365); % 2011 post echogram
time_offset.P12 = (365/365); % 2012
time_offset.P13 = (109/365); % 2013
time_offset.P13_2 = (256/365); % 2013 post echogram
time_offset.P14 = (132/365); % 2014
time_offset.P14_2 = (233/365); % 2014 post echogram
time_offset.P15 = (365/365); % 2015
time_offset.P16 = (365/365); % 2016
time_offset.P17 = (89/365); % 2017

% total time offset
time_offset.N_years = (time_offset.P10 + time_offset.P11 + time_offset.P11_2...
    + time_offset.P12 + time_offset.P13 + time_offset.P13_2 + time_offset.P14...
    + time_offset.P14_2 + time_offset.P15 + time_offset.P16 + time_offset.P17); 
...
for i = 1:numel(XY_data)
    ...
    % 2011 - 2013
    XY_data(i).SMB_11_2t = (XY_data(i).Interp_SMB_11*time_offset.P11_2);
    XY_data(i).SMB_12t = (XY_data(i).Interp_SMB_12*time_offset.P12);
    XY_data(i).SMB_13t = (XY_data(i).Interp_SMB_13*time_offset.P13);
    % 2013 - 2014
    XY_data(i).SMB_13_2t = (XY_data(i).Interp_SMB_13*time_offset.P13_2);
    ...
    %2010 - 2017 mean
    XY_data(i).SMB_10_17_mean = (XY_data(i).SMB_10t + XY_data(i).SMB_11t + ...
      XY_data(i).SMB_11_2t + XY_data(i).SMB_12t + XY_data(i).SMB_13t + ...
      XY_data(i).SMB_13_2t + XY_data(i).SMB_14t + XY_data(i).SMB_14_2t + ...
...
for i = 1:numel(XY_data)
    ...
    % 2011 - 2013
    XY_data(i).div_11_2t = (XY_data(i).Interp_Div_09_10*time_offset.P11_2);
    XY_data(i).div_12t = (XY_data(i).Interp_Div_12_13*time_offset.P12);
    XY_data(i).div_13t = (XY_data(i).Interp_Div_12_13*time_offset.P13);
    % 2013 - 2014
    XY_data(i).div_13_2t = (XY_data(i).Interp_Div_12_13*time_offset.P13_2);
    ...
    %2010 - 2017 mean
    XY_data(i).div_10_17_mean = (XY_data(i).div_10t + XY_data(i).div_11t + ...
      XY_data(i).div_11_2t + XY_data(i).div_12t + XY_data(i).div_13t + ...
      XY_data(i).div_13_2t + XY_data(i).div_14t + XY_data(i).div_14_2t + ...
      XY_data(i).div_15t + XY_data(i).div_16t + XY_data(i).div_17t);
    % 2010 - 2017 smooth
    XY_data(i).div_10_17_mean_s = movmean(XY_data(i).div_10_17_mean, 10, 'omitnan');
end
...
%% ANNUAL MELT RATES 
% 2010 - 2011: Melt, Dynamic Thinning, Mean SMB
...
% SMB
XY_data(1).Mean_SMB = (XY_data(1).SMB_10t + XY_data(1).SMB_11t);
XY_data(1).Mean_SMB_simple = XY_data(1).Interp_SMB_10;
XY_data(1).Mean_SMB_simple2 = (XY_data(1).Interp_SMB_10 + XY_data(1).Interp_SMB_11);

% Dynamic Thinning
XY_data(1).Dynamic_component = ((XY_data(1).div_10t + XY_data(1).div_11t)...
    .*XY_data(1).Mean_Thickness);
XY_data(1).Dynamic_component_simple = (XY_data(1).Interp_Div_09_10.*...
    XY_data(1).Mean_Thickness);
XY_data(1).Dynamic_component_simple2 = ((XY_data(1).Interp_Div_09_10 + XY_data(1).Interp_Div_09_10)...
    .*XY_data(1).Mean_Thickness);

% Total Melt
XY_data(1).Melt_SMB = (XY_data(1).Interp_Thickness - XY_data(2).Interp_Thickness) - XY_data(1).Dynamic_component - XY_data(1).Mean_SMB;
XY_data(1).Melt_SMB_bed = XY_data(1).Bed_diff - XY_data(1).Dynamic_component - XY_data(1).Mean_SMB;
XY_data(1).Melt_SMB_simple = XY_data(1).Bed_diff - XY_data(1).Dynamic_component_simple - XY_data(1).Mean_SMB_simple;
XY_data(1).Melt_SMB_simple2 = XY_data(1).Bed_diff - XY_data(1).Dynamic_component_simple2 - XY_data(1).Mean_SMB_simple2;
...
XY_data(1).Melt_SMB_bed_yr = (XY_data(1).Bed_diff - XY_data(1).Dynamic_component - XY_data(1).Mean_SMB)/...
    XY_data(1).total_time_offset;
XY_data(1).Melt_SMB_simple_yr = (XY_data(1).Bed_diff - XY_data(1).Dynamic_component_simple - XY_data(1).Mean_SMB_simple)/...
    XY_data(1).total_time_offset;
XY_data(1).Melt_SMB_simple2_yr = (XY_data(1).Bed_diff - XY_data(1).Dynamic_component_simple2 - XY_data(1).Mean_SMB_simple2)/...
    XY_data(1).total_time_offset;
...
hold on
plot(XY_data(1).Interp_AT_Dist/1e3,  XY_data(1).Mean_SMB_simple);
plot(XY_data(1).Interp_AT_Dist/1e3,  XY_data(1).Mean_SMB_simple2);
ylim([-2.5 -1]);
ylabel('SMB (m/yr)');
title('Mean SMB')
...
hold on
plot(XY_data(1).Interp_AT_Dist/1e3,  XY_data(1).Dynamic_component_simple);
plot(XY_data(1).Interp_AT_Dist/1e3,  XY_data(1).Dynamic_component_simple2);
ylim([-20 10]);
...
hold on
plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(1).Melt_SMB_bed);
plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(1).Melt_SMB_simple);
plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(1).Melt_SMB_simple2);
%ylim([-10 100]);
ylabel('Basal Melt (m)');
...
hold on
plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(1).Melt_SMB_bed_yr);
plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(1).Melt_SMB_simple_yr);
plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(1).Melt_SMB_simple2_yr);
%ylim([-10 100]);
ylabel('Basal Melt (m)');
title('Total Basal Melt');
legend('Time offset thickness','Time offset bed','Single year','mean 2 year','Location','eastoutside');
...
%% 2011 - 2013: Melt, Dynamic Thinning, Mean SMB
...
% Total Time offset
XY_data(2).total_time_offset = time_offset.P11_2 + time_offset.P12 + time_offset.P13;

% SMB
XY_data(2).Mean_SMB = (XY_data(2).SMB_11_2t + XY_data(2).SMB_12t + XY_data(2).SMB_13t);
XY_data(2).Mean_SMB_simple = (XY_data(2).Interp_SMB_11 + XY_data(2).Interp_SMB_12);
XY_data(2).Mean_SMB_simple2 = ((XY_data(2).Interp_SMB_11 + XY_data(1).Interp_SMB_12 + XY_data(2).Interp_SMB_13)/3);

% Dynamic Thinning
XY_data(2).Dynamic_component = ((XY_data(2).div_11_2t + XY_data(2).div_12t + XY_data(2).div_13t)...
    .*XY_data(2).Mean_Thickness);
XY_data(2).Dynamic_component_simple = (((XY_data(2).Interp_Div_09_10 + XY_data(2).Interp_Div_12_13)/2)...
    .*XY_data(2).Mean_Thickness);
XY_data(2).Dynamic_component_simple2 = (((XY_data(2).Interp_Div_09_10 + XY_data(2).Interp_Div_12_13 + XY_data(2).Interp_Div_12_13)/3)...
    .*XY_data(2).Mean_Thickness);

% Total Melt
XY_data(2).Melt_SMB = (XY_data(2).Interp_Thickness - XY_data(3).Interp_Thickness) - XY_data(2).Dynamic_component - XY_data(2).Mean_SMB;
XY_data(2).Melt_SMB_bed = XY_data(2).Bed_diff - XY_data(2).Dynamic_component - XY_data(2).Mean_SMB;
XY_data(2).Melt_SMB_simple = XY_data(2).Bed_diff - XY_data(2).Dynamic_component_simple - XY_data(2).Mean_SMB_simple;
XY_data(2).Melt_SMB_simple2 = XY_data(2).Bed_diff - XY_data(2).Dynamic_component_simple2 - XY_data(2).Mean_SMB_simple2;
...
XY_data(2).Melt_SMB_bed_yr = (XY_data(2).Bed_diff - XY_data(2).Dynamic_component - XY_data(2).Mean_SMB)/...
    XY_data(2).total_time_offset;
XY_data(2).Melt_SMB_simple_yr = (XY_data(2).Bed_diff - XY_data(2).Dynamic_component_simple - XY_data(2).Mean_SMB_simple)/...
    XY_data(2).total_time_offset;
XY_data(2).Melt_SMB_simple2_yr = (XY_data(2).Bed_diff - XY_data(2).Dynamic_component_simple2 - XY_data(2).Mean_SMB_simple2)/...
    XY_data(2).total_time_offset;
...
hold on
plot(XY_data(1).Interp_AT_Dist/1e3,  XY_data(2).Mean_SMB_simple);
plot(XY_data(1).Interp_AT_Dist/1e3,  XY_data(2).Mean_SMB_simple2);
%ylim([-2.5 -1]);
ylabel('SMB (m/yr)');
title('Mean SMB')
legend('Time offset','Single year','mean 2 year','Location','eastoutside');
...
hold on
plot(XY_data(1).Interp_AT_Dist/1e3,  XY_data(2).Dynamic_component_simple);
plot(XY_data(1).Interp_AT_Dist/1e3,  XY_data(2).Dynamic_component_simple2);
ylim([-20 10]);
ylabel('Thinning Rate (m/yr)');
title('Mean Dynamic Thinning')
legend('Time offset','Single year','mean 2 year','Location','eastoutside');
...
hold on
plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(2).Melt_SMB_bed);
plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(2).Melt_SMB_simple);
plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(2).Melt_SMB_simple2);
%ylim([-10 100]);
ylabel('Basal Melt (m)');
title('Total Basal Melt');
legend('Time offset thickness','Time offset bed','Single year','mean 2 year','Location','eastoutside');
...
hold on
plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(2).Melt_SMB_bed_yr);
plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(2).Melt_SMB_simple_yr);
plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(2).Melt_SMB_simple2_yr);
%ylim([-10 100]);
ylabel('Basal Melt (m)');
...
% Time offset
XY_data(3).total_time_offset = time_offset.P13_2 + time_offset.P14;

% SMB
% original XY_data(3).Mean_SMB = ((XY_data(3).SMB_13_2t + XY_data(1).SMB_14t)/(time_offset.P13_2 + time_offset.P14));
XY_data(3).Mean_SMB = (XY_data(3).SMB_13_2t + XY_data(1).SMB_14t);
XY_data(3).Mean_SMB_simple = (XY_data(3).Interp_SMB_13);
XY_data(3).Mean_SMB_simple2 = ((XY_data(3).Interp_SMB_13 + XY_data(1).Interp_SMB_14));

% Dynamic Thinning
XY_data(3).Dynamic_component = (((XY_data(3).div_13_2t + XY_data(3).div_14t))...
    .*XY_data(3).Mean_Thickness);
XY_data(3).Dynamic_component_simple = (XY_data(2).Interp_Div_12_13...
    .*XY_data(3).Mean_Thickness);
XY_data(3).Dynamic_component_simple2 = (((XY_data(2).Interp_Div_12_13 + XY_data(2).Interp_Div_12_13))...
    .*XY_data(3).Mean_Thickness);

% Total Melt
XY_data(3).Melt_SMB = (XY_data(3).Interp_Thickness - XY_data(4).Interp_Thickness) - XY_data(3).Dynamic_component - XY_data(3).Mean_SMB;
XY_data(3).Melt_SMB_bed = XY_data(3).Bed_diff - XY_data(3).Dynamic_component - XY_data(3).Mean_SMB;
XY_data(3).Melt_SMB_simple = XY_data(3).Bed_diff - XY_data(3).Dynamic_component_simple - XY_data(3).Mean_SMB_simple;
XY_data(3).Melt_SMB_simple2 = XY_data(3).Bed_diff - XY_data(3).Dynamic_component_simple2 - XY_data(3).Mean_SMB_simple2;
...
XY_data(3).Melt_SMB_bed_yr = (XY_data(3).Bed_diff - XY_data(3).Dynamic_component - XY_data(3).Mean_SMB)/...
    XY_data(3).total_time_offset;
XY_data(3).Melt_SMB_simple_yr = (XY_data(3).Bed_diff - XY_data(3).Dynamic_component_simple - XY_data(3).Mean_SMB_simple)/...
    XY_data(3).total_time_offset;
XY_data(3).Melt_SMB_simple2_yr = (XY_data(3).Bed_diff - XY_data(3).Dynamic_component_simple2 - XY_data(3).Mean_SMB_simple2)/...
    XY_data(3).total_time_offset;
...
hold on
plot(XY_data(1).Interp_AT_Dist/1e3,  XY_data(3).Mean_SMB_simple);
plot(XY_data(1).Interp_AT_Dist/1e3,  XY_data(3).Mean_SMB_simple2);
%ylim([-2.2 -1]);
ylabel('SMB (m/yr)');
title('Mean SMB')
legend('Time offset','Single year','mean 2 year','Location','eastoutside');
...
hold on
plot(XY_data(1).Interp_AT_Dist/1e3,  XY_data(3).Dynamic_component_simple);
plot(XY_data(1).Interp_AT_Dist/1e3,  XY_data(3).Dynamic_component_simple2);
ylim([-20 10]);
ylabel('Thinning Rate (m/yr)');
title('Mean Dynamic Thinning')
legend('Time offset','Single year','mean 2 year','Location','eastoutside');
...
hold on
plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(3).Melt_SMB_bed);
plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(3).Melt_SMB_simple);
plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(3).Melt_SMB_simple2);
ylim([-20 200]);
ylabel('Basal Melt (m)');
title('Total Basal Melt');
legend('Time offset','Single year','mean 2 year','Location','eastoutside');
...
hold on
plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(3).Melt_SMB_bed_yr);
plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(3).Melt_SMB_simple_yr);
plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(3).Melt_SMB_simple2_yr);
ylim([-20 200]);
ylabel('Basal Melt (m)');
title('Annual Basal Melt');
legend('Time offset','Single year','mean 2 year','Location','eastoutside');
...
% Time Offset
XY_data(4).total_time_offset = time_offset.P14_2 + time_offset.P15 + time_offset.P16 + time_offset.P17;

% SMB
% original XY_data(4).Mean_SMB = ((XY_data(4).SMB_14_2t + XY_data(4).SMB_15t + XY_data(4).SMB_16t + XY_data(4).SMB_17t)/...
%    (time_offset.P14_2 + time_offset.P15 + time_offset.P16 + time_offset.P17));
XY_data(4).Mean_SMB = (XY_data(4).SMB_14_2t + XY_data(4).SMB_15t + XY_data(4).SMB_16t + XY_data(4).SMB_17t);
XY_data(4).Mean_SMB_simple = (XY_data(4).Interp_SMB_15 + XY_data(4).Interp_SMB_16 + XY_data(4).Interp_SMB_17);
XY_data(4).Mean_SMB_simple2 = ((XY_data(1).Interp_SMB_14 + XY_data(4).Interp_SMB_15 + XY_data(4).Interp_SMB_16 + XY_data(4).Interp_SMB_17));

% Dynamic Thinning
XY_data(4).Dynamic_component = (((XY_data(4).div_14_2t + XY_data(4).div_15t + XY_data(4).div_16t + XY_data(4).div_17t)/...
    (time_offset.P14_2 + time_offset.P15 + time_offset.P16 + time_offset.P17)).*XY_data(4).Mean_Thickness);
XY_data(4).Dynamic_component_simple = (((XY_data(4).Interp_Div_15_16 + XY_data(4).Interp_Div_16_17 + XY_data(4).Interp_Div_17_18))...
    .*XY_data(4).Mean_Thickness);
XY_data(4).Dynamic_component_simple2 = (((XY_data(4).Interp_Div_14_15 + XY_data(4).Interp_Div_15_16 + XY_data(4).Interp_Div_16_17 + XY_data(4).Interp_Div_17_18))...
    .*XY_data(4).Mean_Thickness);

% Total Melt
XY_data(4).Melt_SMB = ((XY_data(4).Interp_Thickness - XY_data(5).Interp_Thickness) - XY_data(4).Dynamic_component - XY_data(4).Mean_SMB);
XY_data(4).Melt_SMB_bed = XY_data(4).Bed_diff - XY_data(4).Dynamic_component - XY_data(4).Mean_SMB;
XY_data(4).Melt_SMB_simple = XY_data(4).Bed_diff - XY_data(4).Dynamic_component_simple - XY_data(4).Mean_SMB_simple;
XY_data(4).Melt_SMB_simple2 = XY_data(4).Bed_diff - XY_data(4).Dynamic_component_simple2 - XY_data(4).Mean_SMB_simple2;
...
XY_data(4).Melt_SMB_bed_yr = (XY_data(4).Bed_diff - XY_data(4).Dynamic_component - XY_data(4).Mean_SMB)/...
    XY_data(4).total_time_offset;
XY_data(4).Melt_SMB_simple_yr = (XY_data(4).Bed_diff - XY_data(4).Dynamic_component_simple - XY_data(4).Mean_SMB_simple)/...
    XY_data(4).total_time_offset;
XY_data(4).Melt_SMB_simple2_yr = (XY_data(4).Bed_diff - XY_data(4).Dynamic_component_simple2 - XY_data(4).Mean_SMB_simple2)/...
    XY_data(4).total_time_offset;
...
hold on
plot(XY_data(1).Interp_AT_Dist/1e3,  XY_data(4).Mean_SMB_simple);
plot(XY_data(1).Interp_AT_Dist/1e3,  XY_data(4).Mean_SMB_simple2);
%ylim([-2.2 -1]);
ylabel('SMB (m/yr)');
title('Mean SMB')
legend('Time offset','Single year','mean 2 year','Location','eastoutside');
...
hold on
plot(XY_data(1).Interp_AT_Dist/1e3,  XY_data(4).Dynamic_component_simple);
plot(XY_data(1).Interp_AT_Dist/1e3,  XY_data(4).Dynamic_component_simple2);
ylim([-50 20]);
ylabel('Thinning Rate (m/yr)');
title('Mean Dynamic Thinning')
legend('Time offset','Single year','mean 2 year','Location','eastoutside');
...
hold on
plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(4).Melt_SMB_bed);
plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(4).Melt_SMB_simple);
plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(4).Melt_SMB_simple2);
ylim([-50 250]);
ylabel('Basal Melt (m)');
title('Total Basal Melt');
legend('Time offset thickness','Time offset bed','Single year','mean 2 year','Location','eastoutside');
...
hold on
plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(4).Melt_SMB_bed_yr);
plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(4).Melt_SMB_simple_yr);
plot(XY_data(1).Interp_AT_Dist/1e3, XY_data(4).Melt_SMB_simple2_yr);
ylim([-50 250]);
ylabel('Basal Melt (m)');
title('Annual Basal Melt');
legend('Time offset thickness','Time offset bed','Single year','mean 2 year','Location','eastoutside');
...
title('Elevation Profiles');
ylabel('elevation (m)');
suptitle('Petermann Line 4 2014-2017')

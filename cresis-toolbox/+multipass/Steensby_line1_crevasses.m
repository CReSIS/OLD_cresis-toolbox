...
% writematrix(crevasse_2007, 'S1_Crevasse_2007.csv','Delimiter','comma');
writematrix(crevasse_2011, 'S1_Crevasse_2011.csv','Delimiter','comma');
writematrix(crevasse_2013, 'S1_Crevasse_2013.csv','Delimiter','comma');
writematrix(crevasse_2015, 'S1_Crevasse_2015.csv','Delimiter','comma');
writematrix(crevasse_2019, 'S1_Crevasse_2019.csv','Delimiter','comma');
%% Reload new csv in after editting
% AT_data.crevasse.base_pic_P07 = csvread('S1_Crevasse_2007.csv');
AT_data.crevasse.base_pic_P11 = csvread('S1_Crevasse_2011.csv');
AT_data.crevasse.base_pic_P13 = csvread('S1_Crevasse_2013.csv');
AT_data.crevasse.base_pic_P15 = csvread('S1_Crevasse_2015.csv');
AT_data.crevasse.base_pic_P19 = csvread('S1_Crevasse_2019.csv');

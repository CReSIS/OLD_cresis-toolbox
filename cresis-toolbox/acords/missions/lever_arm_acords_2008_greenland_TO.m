function [phase_center] = lever_arm_acords_2008_greenland_TO(tx_weights, rxchannel)
% [phase_center] = lever_arm_acords_2008_greenland_TO(tx_weights, rxchannel)
%
...
phase_center = (LArx(:,rxchannel) + LAtx_pc)./2;

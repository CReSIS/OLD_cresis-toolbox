...
% param_fns{end+1} = 'accum_param_2018_Greenland_P3.xls'; % Season not completed/NOT CREATED
...
% param_fns{end+1} = 'snow_param_2020_SouthDakota_N1KU.xls'; % Season not completed

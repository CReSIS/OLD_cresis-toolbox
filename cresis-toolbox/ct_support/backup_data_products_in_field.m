...
if 1
  ...
  copy_dirs(end+1) = struct( ...
    ...
    'get_filenames_args',{{'',day_string,''}});
  copy_dirs(end+1) = struct( ...
    'input_dir',fullfile(gRadar.data_support_path,'2017_Antarctica_P3'), ...
    'output_dir',fullfile(archive_dir_base,'2017_Antarctica_P3'), ...
    'get_filenames_args',{{'',day_string,''}});
...
elseif 0
  ...
  copy_dirs(end+1) = struct( ...
    ...
    'get_filenames_args',{{'',day_string,''}});
  copy_dirs(end+1) = struct( ...
    'input_dir',fullfile(archive_dir_base,'2017_Antarctica_P3'), ...
    'output_dir',fullfile(gRadar.data_support_path,'2017_Antarctica_P3'), ...
    'get_filenames_args',{{'',day_string,''}});
end

...
param_override.echo_stats.data_type = 'CSARP_post/qlook';
param_override.echo_stats.echogram_img = 0;
param_override.echo_stats.noise_bins = [-400 -100];
param_override.echo_stats.signal_bins = [-99 500];
param_override.echo_stats.detrend_threshold = inf;
param_override.echo_stats.sum_threshold = 100;
param_override.echo_stats.peak_wfs_bins = [-200:40];

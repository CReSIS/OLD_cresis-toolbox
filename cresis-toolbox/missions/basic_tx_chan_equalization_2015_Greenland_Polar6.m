...
param.rbins = [1 inf];
% param.rbins = [1200 1800]; % 165-510 MHz
% param.rbins = [200 300]; % 170-230 MHz
param.rbins = [100 170]; % 180-210 MHz
...
% param.noise_rbins = 1000:1200; % 165-510 MHz
% param.noise_rbins = 150:200; % 170-230 MHz
param.noise_rbins = 75:100; % 180-210 MHz
...
% max_DDS_amp = 15000;
max_DDS_amp = [3000 3000 3000 3000 3000 3000 3000 3000];
...
update_delay = true; % START WITH THIS ONE

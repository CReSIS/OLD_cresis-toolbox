...
arena.dac(dac_idx).desiredAlignMin = -2;
arena.dac(dac_idx).desiredAlignMax = 12;
arena.dac(dac_idx).dcoPhase = 80;
dac_idx = dac_idx + 1;
arena.dac(dac_idx).name = 'awg1';
arena.dac(dac_idx).type = 'dac-ad9129_0012';
arena.dac(dac_idx).dacClk = fs_dac;
arena.dac(dac_idx).desiredAlignMin = -12;
arena.dac(dac_idx).desiredAlignMax = 2;
arena.dac(dac_idx).dcoPhase = 80;
...
arena.adc(adc_idx).desiredAlignMax = 5;
arena.adc(adc_idx).ip = '10.0.0.100';
arena.adc(adc_idx).outputSelect = 0;
arena.adc(adc_idx).gain_dB = [2.4 2.4];
...
% Noise Mode
default.records.data_map = {[2 0 1 1;2 1 1 2;5 0 2 1;5 1 2 2],[2 0 1 3;2 1 1 4;5 0 2 3;5 1 2 4]};

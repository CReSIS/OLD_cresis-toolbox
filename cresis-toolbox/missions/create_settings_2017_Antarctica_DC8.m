% script create_settings_2017_Antarctica_DC8
%
...
if 1
  ...
  % After transmit calibration during Oct ?, 2017 test flight (10 us)
  final_DDS_phase{end+1} = [];
  final_DDS_amp{end+1} = [];
  final_DDS_time{end+1} =  [];
  final_DDS_phase_no_time{end+1} = [];
  final_tx_mask = [1 1 0 0 0 0 0 0];
end
...
physical_constants;
param = [];
param.season_name = '2017_Antarctica_DC8';
param.radar_name = 'rds';
param.gps_source = 'atm-final20170301';
clear phase_centers;
for tx_chan = 1:6

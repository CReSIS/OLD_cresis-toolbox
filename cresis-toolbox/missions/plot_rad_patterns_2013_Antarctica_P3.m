% tmp = load('c:\tmp\2013_Greenland_P3\rds_radiation_pattern_pingpong');
rds_radiation_pattern_fn = '/cresis/scratch1/paden/rds_radiation_pattern_2013_Antarctica_P3_v2.mat';
...
for ant_idx = [1 2 3 4 5 6 7 8]%1:length(tmp.surf_vals)

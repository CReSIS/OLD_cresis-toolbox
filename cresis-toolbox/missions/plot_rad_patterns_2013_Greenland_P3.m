% script plot_rad_patterns_2013_Greenland_P3
%
% Uses output from basic_rds_radiation_pattern_*.m functions
%
% Author: John Paden

tmp = load('c:\tmp\2013_Greenland_P3\rds_radiation_pattern_2.mat');
% tmp = load('C:\tmp\rds_radiation_pattern_2013_Antarctica_P3.mat');
...
for ant_idx = 1:8%length(tmp.surf_vals)

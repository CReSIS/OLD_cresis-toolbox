...
param.config.base_dir{cur_idx} = '/mnt/raid_ssdyellow/';
param.config.config_folder_names{cur_idx} = '20221209';
param.config.board_folder_names{cur_idx} = '20221209/%b';
param.config.date_str{cur_idx} = '20221209';

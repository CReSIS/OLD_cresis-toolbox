...
param.season_name = '2021_Greenland_Polar5';
...
default.radar.Tadc_adjust = 0.00000851003077; % System time delay: leave this empty or set it to zero at first, determine this value later using data over surface with known height or from surface multiple
...
default.radar.wfs(1).rx_paths = [1:8];
default.radar.wfs(1).Tadc_adjust = 0.00000851003077;

...
param.max_duty_cycle = 0.12;
param.create_IQ = false;
altitude_agl_feet = 1500;
swath_beamwidth_deg = 45;
ice_thickness = 1200;
ice_thickness_guard = 600;
param.tg.staged_recording = false;

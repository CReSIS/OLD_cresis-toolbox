...
param.noise_rbins = 500:700;
param.noise_rbins = 1000:1100;
...
param.base_dir = '/cresis/snfs1/data/MCoRDS/2014_Greenland_P3/20140307/';
param.base_dir = '/cresis/snfs1/data/MCoRDS/2014_Greenland_P3/20140312/';
...
param.wf_mapping = [1 2 3 4 5 6 7 0];
...
param.bad_chan_mask = [0 0 0 0 0 0 0 1];
...
Hwindow_desired = [1 1 1 1 1 1 1 0];

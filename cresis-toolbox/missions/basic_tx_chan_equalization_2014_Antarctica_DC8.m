...
param.wf_mapping = [1 2 3 4 5 6 0 0];
...
param.bad_chan_mask = [0 0 0 0 0 0 1 1];
...
Hwindow_desired = [1 1 1 1 1 1 0 0];
% max_DDS_amp = Amplitudes will be normalized to this scalar value
% max_DDS_amp = 15000;
max_DDS_amp = [15000 15000 17000 15920 15000 14150 0 0];

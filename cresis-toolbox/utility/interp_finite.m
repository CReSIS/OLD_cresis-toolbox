function vals = interp_finite(vals,default_val)
% vals = interp_finite(vals,default_val)
%
...
vals(~good_mask) = interp1(find(good_mask),vals(good_mask),find(~good_mask),'linear');

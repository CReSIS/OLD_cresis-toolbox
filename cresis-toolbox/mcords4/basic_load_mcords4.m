...
hdr.seconds = ...
  3600*(10*mod(floor(hdr_data(10,:)/2^8),2^4) + mod(floor(hdr_data(10,:)/2^12),2^4)) ...
  + 60*(10*mod(hdr_data(9,:),2^4) + mod(floor(hdr_data(9,:)/2^4),2^4)) ...
  + (10*mod(floor(hdr_data(9,:)/2^8),2^4) + mod(floor(hdr_data(9,:)/2^12),2^4));

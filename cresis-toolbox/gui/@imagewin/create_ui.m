...
signal_filters = {'10*log10(X)', ...
  'echo_xcorr(10*log10(X),echo_xcorr_profile(''short_unitstep''))', ...
  'echo_xcorr(10*log10(X),echo_xcorr_profile(''xlong_unitstep''))', ...
  'echo_xcorr(10*log10(X),echo_xcorr_profile(''xlong_unitstep_delay''))', ...
  'echo_xcorr(10*log10(filter2(ones(round(param1*2+1),round(param2*2+1))/round(param1*2+1)/round(param2*2+1),X)),echo_xcorr_profile(''short_unitstep''))', ...
  '10*log10(filter2(ones(round(param1*2+1),round(param2*2+1))/round(param1*2+1)/round(param2*2+1),X))', ...
  };
